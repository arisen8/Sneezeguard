...
<style>
.account-notifications{margin-top:100px;}
.account-notifications h2{font-size:20px;}
...
<div class="container account-notifications" onmouseover="openCity(event, 'Hide');hide_cart_data()"><!-- deepak 4-1-2021 -->

<div class="form_white">
<table width="96%" cellpadding="0" cellspacing="0" style="padding:5px;" align="center"> 
...
?>
  ...
  <table width="100%" class="accountnotifications">
	...
	<tr>
		...
		<td align="right"><!--<input type="image" class="updatebutton" style="width: 230px;" src="img/new_icons/continue.png" alt="Continue" title=" Continue " primary="" onclick="javascript:document.forms['checkout_payment'].submit();">--><button type="submit" class="btn btn-outline-dark" onclick="javascript:document.forms['checkout_payment'].submit();">Continue</button></td>
      </tr>
	
	<!--
	<tr>
      	<td><?php echo '<a href="'.tep_href_link(FILENAME_ACCOUNT, '', 'SSL').'">'.tep_image_button('button_back.gif', IMAGE_BUTTON_BACK).'</a>';?></td><td align="right"><?php echo tep_image_submit("continue.gif", IMAGE_BUTTON_CONTINUE, 'primary'); ?></td>
      </tr>
	  -->
