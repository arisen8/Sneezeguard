...
(function ($, document, window) {
	...
	function appendHTML() {
		if (!$box && document.body) {
			...
			$content.append('<p style="display:block;position: absolute;">hiiiiii</p>');
   ...
   //          '<img src="fb.png" style="width: 35px; border-radius: 6px;margin-left: 36%;margin-bottom: 10px;">'+
   //      '</a>'+
   ...
   //          '<img src="twitter.png" style="width: 35px; border-radius: 6px;  margin-left: 15px;margin-bottom: 10px;">'+
   //      '</a>'+    
   ...
   //          '<img src="whatsapp.png" style="width: 35px; border-radius: 6px;    margin-left: 15px;margin-bottom: 10px;">'+
   //      '</a>'+
   ...
   //          '<img src="linkdn.jpg" style="width: 35px; border-radius: 6px;    margin-left: 15px;margin-bottom: 10px;">'+
   //      '</a>'+    
   //        '</div>'+
   //      '</div>'
   //      );
