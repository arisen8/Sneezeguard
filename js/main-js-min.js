$(document).ready(function() {
    ...
    $('.new-arrival-imgs').mouseover(function() {
        let model_name = $(this).data('modelname');

        $(this).attr('src', 'images/new_arival/' + model_name + '/animation.gif');
        // let ids=$(this).id;
        //alert(model_name);
    })

    if (screen.width <= 780) {
        $('.new-arrival-EP8').attr('src', 'images/new_arival/EP8/animation.gif');
        $('.new-arrival-ORBIT720').attr('src', 'images/new_arival/ORBIT720/animation.gif');
        $('.new-arrival-EP6').attr('src', 'images/new_arival/EP6/animation.gif');
        $('.new-arrival-EP5').attr('src', 'images/new_arival/EP5/animation.gif');
    }
