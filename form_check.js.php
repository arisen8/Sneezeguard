...
var osCsid= '<?php echo ($_GET['osCsid']);?>';
  jQuery(document).ready(function(){
        jQuery.colorbox({href:'CheckAddress.php?osCsid='+osCsid+'&Array2='+e, iframe:true,  width:600, height:400})
      });	
   //submitted = true;
   return false;
  }
...
//$('#s').show();
        //jQuery.colorbox({href:'#s', inline:true, open:true, width:600, height:400,onClosed: function() {
               //  $('#s').hide();
          //  },
           // onOpen: function() {
              //   $('#s').show();
