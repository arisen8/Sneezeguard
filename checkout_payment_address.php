...
<div class="row">
  <div class="col-md-6 col-sm-6 border-right p-5">
...
?>
  ...
  <div class="contentText">
    ...
    <table>
    	<tr><?php echo tep_address_label($customer_id, $customer_default_address_id, true, ' ', '<br />'); ?></td></tr>
        <tr><td width="100px" valign="top">&nbsp;</td>
        </tr>
    </table>
...
?>
      ...
      <tr>
        <td colspan="2"  style="padding-right:170px; padding-left:15px;"><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?></td>
      </tr>
...
<?php
  ...
  if ($addresses_count < ADDRESS_BOOK_ENTRIES) {
?>
  </div>
...
-->
  ...
  <div class="p-4">
    <input class="btn btn-outline-dark form-control p-2" type="submit" value="Continue">
  </div>
</div>
