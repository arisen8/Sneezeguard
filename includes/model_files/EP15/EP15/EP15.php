...
var product_name_price=new Array(arr_len);//array defined to show the price in bay!
				product_name_price['EP5-22 End Post Brushed Stainless Steel']=new Array("648", "64.0000");
                 product_name_price['EP5-22 End Post Powder Coated Black']=new Array("649", "64.0000");
                 product_name_price['EP5-22 End Post Brushed Aluminum']=new Array("650", "55.0000");
				 product_name_price['EP5-18 End Post Brushed Stainless Steel']=new Array("669", "64.0000");
                 product_name_price['EP5-18 End Post Powder Coated Black']=new Array("670", "64.0000");
                 product_name_price['EP5-18 End Post Brushed Aluminum']=new Array("671", "55.0000");
				 product_name_price['EP5-12 End Post Brushed Stainless Steel']=new Array("690", "64.0000");
                 product_name_price['EP5-12 End Post Powder Coated Black']=new Array("691", "64.0000");
                 product_name_price['EP5-12 End Post Brushed Aluminum']=new Array("692", "55.0000");
				 product_name_price['EP5-26 End Post Brushed Aluminum']=new Array("2465", "61.0000");
				 product_name_price['EP5-26 End Post Brushed Stainless Steel']=new Array("2473", "71.0000");
				 product_name_price['EP5-26 End Post Powder Coated Black']=new Array("3066", "71.0000");
    <?php
        if(isset($HTTP_GET_VARS['id'])){
        ...
        <td>
                               ...
                               <div class="tables-options"  id="hidetable1">         
                                ...
                                <tr>
                                    ...
                                    <tr>
                    <td><a class="thickbox" href='images/EP15/Post_height.jpg' ><h1>Post Height</h1></a></td><td>
...
//STRUCTURE for 1 bay
	...
	if($_REQUEST['type']=='1BAY') {
      ?>
            ...
            <tr class="test-length">
                <td class="test-lenght1bay" ><a class="thickbox" href='images/EP15/1bay_faceA.jpg' ><h1>Face Length A</h1></a></td><td>
 ...
 <?php  }
    ...
    if($_REQUEST['type']=='2BAY'){
        ?><tr class="test-length">
                <td class="test-lenght2baya"><a class="thickbox" href='images/EP15/2bay_faceA.jpg'><h1>Face Length A</h1></a></td><td>
            ...
            <tr class="test-length">
                <td class="test-lenght2bayb"><a class="thickbox" href='images/EP15/2bay_faceB.jpg' ><h1>Face Length B</h1></a></td><td>
  ...
  //structure for 3bay
    if($_REQUEST['type']=='3BAY'){
       ?> <tr class="test-length">
                <td class="test-lenght3baya"><a class="thickbox" href='images/EP15/3bay_faceA.jpg'><h1>Face Length A</h1></a></td><td>
					<span id="face_length_a_span">
                    <select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);show_lightbar_pupup(this.form);">
                        <option value="select">Select</option>
            ...
            <tr class="test-length">
                <td class="test-lenght3bayb"><a class="thickbox" href='images/EP15/3bay_faceB.jpg' ><h1>Face Length B</h1></a></td><td>
					<span id="face_length_b_span">
                    <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);show_lightbar_pupup(this.form);">
                        <option value="select" class="instock">Select</option>
						<option value="12" class="customsame" style="display:none;">8"</option>
            ...
            <tr class="test-length">
                <td class="test-lenght3bayc"><a class="thickbox" href='images/EP15/3bay_faceC.jpg' ><h1>Face Length C</h1></a></td><td>
  ...
  if($_REQUEST['type']=='4BAY'){
      ?> <tr class="test-length">
                <td class="test-lenght4baya"><a class="thickbox" href='images/EP15/4bay_faceA.jpg' ><h1>Face Length A</h1></a></td><td>
					<span id="face_length_a_span">
                    <select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);show_lightbar_pupup(this.form);">
                        <option value="select">Select</option>
            ...
            <tr class="test-length">
                <td class="test-lenght4bayb"><a class="thickbox" href='images/EP15/4bay_faceB.jpg' ><h1>Face Length B</h1></a></td><td>
					<span id="face_length_b_span">
                    <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);show_lightbar_pupup(this.form);">
                        <option value="select" class="instock">Select</option>
						<option value="12" class="customsame" style="display:none;">8"</option>
            ...
            <tr class="test-length">
                <td class="test-lenght4bayc"><a class="thickbox" href='images/EP15/4bay_faceC.jpg' ><h1>Face Length C</h1></a></td><td>
					<span id="face_length_c_span">
                    <select name="face_length_c" id="face_length_c" class="usecustom" onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);show_lightbar_pupup(this.form);">
                        <option value="select" class="instock">Select</option>
						<option value="12" class="customsame" style="display:none;">8"</option>
			...
			<tr class="test-length">
                <td class="test-lenght4bayd"><a class="thickbox" href='images/EP15/4bay_faceD.jpg'><h1>Face Length D</h1></a></td><td>
 ...
 <?   }}?>
                                        ...
                                        <td><a class="thickbox" href='images/EP5/Right_length.jpg' ><h1 style="margin-left:20px;">Right Length</h1></a></td><td>
                                            ...
                                            <select name="right_length" onchange="getPriceOfProduct(this.form);nogl(this.form,this.name,this.value);" class="usecustom" id="right_length"> 
                                               ...
                                               <?php
                                                ...
                                                <option value="42" style="display:none;">42&quot;</option>
                                                <option value="custom">Custom</option>
                                                <option value="No Glass">No Glass</option>
                                            </select>
                                            </span>
		...
		<table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
        <tr>
                <td colspan=3><center><h2 class="heading_all" id="extratext"><span style="float:left" class="extra1">&nbsp;&nbsp;3)</span>Extras</h2></center></td>
            </tr>
            <tr id="hidetable3">
...
?>
                ...
                <tr>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP15/post_type.jpg'><h1 style="text-decoration: none;">Corner Post Type</h1></a></td>
                        <td>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP15/post_degree.jpg'><h1 style="text-decoration: none;">Corner Post Angle</h1></a></td>
                        <td>
                ...
                <tr>
				   ...
				   <img src="images/EP15/2BAY/OUTER90D1STPOST.jpg" id="postimg1" /></a></label></td>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP15/3BAY/OUTER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   ...
				   <img src="images/EP15/3BAY/OUTER90D2NDPOST.jpg" id="postimg2" /></a></label></td>
				   </tr>
				   <tr>
                        <td colspan=2 style="height:26px;"></td>
                    </tr>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP15/4BAY/OUTER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   <td style="padding-left:5px;"><label>
				   <input type="radio" name="corner_post" id="2ndcenter" onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
				   <img src="images/EP15/4BAY/OUTER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
				   ...
				   <img src="images/EP15/4BAY/OUTER90D3RDPOST.jpg" id="postimg3"  /></label></td>
			...
			<div id="cart-form"  class="tables-options forgotot11">
				...
				<table id="forgotot" cellpadding="0" align="center" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    <tr>
						...
						<label for="gotocornerpostcheck" id="gotocornerpost" style="text-align:center !important;float:left;"><span class="heading_all" style="float:left;"><span >&nbsp;&nbsp;4)</span></span>Go To Corner Post<span class="blink"><blink><b>New!</b></blink></span></label>
				...
				<table id="forstarightpost" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px; display:none;">
                    <tr>
                        <td colspan=2><h3 class="btspl"><a id="backtostraightpost" style="color:#000000;">
...
<div    class="info-sub-container3" valign="top" align="center" >
    ...
    <tr>
        <td colspan=2><center><h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;<?php if(($_REQUEST['type']=='1BAY')){echo "4)";}else{echo "5)";} ?></span>Quote</h2></center></td>
    </tr>
    <tr>
...
$(document).ready(function(){
	...
	$('[name="post_height"]').change(function(){
		if($(this).val()=='custom'){
			...
			post='yes';
			 ...
			 $msg='<span align="right"><img src="jquery.confirm/EP15.jpg" style="float:right;"><span style="width:250px;display:block;text-align:justify;"><p><span>You have chosen a custom height post. We can manufacture them from 8" to 30" tall in&nbsp;</span><sup>1</sup><span>⁄</span><sub>4</sub><span>" increments. Custom posts can be produced within 24 hours.</span><br><br><span>If you select proceed, the custom posts will default at 8" tall until a new height is selected via the drop down menu.</span></p></span></span>';
			$('.delete').click();
	...
	$('.item .delete').click(function(){
		jsconfirm($msg, category_name, ispost, custom, post ,panel);
	});

});
</script>
<script src="includes/model_files/EP15/EP15.js"></script>