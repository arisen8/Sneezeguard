function getPriceOfProduct(form) {
    ...
    //glass bracket
    glassbracketrightPost = "";
    glassbracketleftPost = "";

    glassbracketrightPostPrice = 0;
    glassbracketleftPostPrice = 0;

    anglePostPrice = 0;
    leftanglePostPrice = 0;
    rightanglePostPrice = 0;
    ...
    foldername = getProductFolderName('EP15') + type_obj.value;
    ...
    //if(category_name=="EP15"){
    leftEndPost = category_name + "-" + height + " Left End Post " + choose_finish_obj.value;
    rightEndPost = category_name + "-" + height + " Right End Post " + choose_finish_obj.value
    ...
    if (glass_face_obj.value == 1) { //I have to change here!
        if (height != "select") {
            leftanglePost = 'EP5-' + height + " End " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
            glassbracketleftPost = 'EP15 Glass Bracket For Left Post ' + choose_finish_obj.value + '';

            rightanglePost = 'EP5-' + height + " End " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
            glassbracketrightPost = 'EP15 Glass Bracket For Right Post ' + choose_finish_obj.value + '';

        }
        if (left_lenght_obj.value != "select") {
            if (left_lenght_obj.value != "No Glass") {
                if (height != "select") {
                    glassName_l = category_name + '-' + height + ' ' + left_lenght_obj.value + '" Left End Glass ';
        ...
        if (right_lenght_obj.value != "select") {
            if (right_lenght_obj.value != "No Glass") {
                if (height != "select") {
                    glassName_r = category_name + '-' + height + ' ' + right_lenght_obj.value + '" Right End Glass ';
                    if (corner_obj.value == "round") {
        ...
        if (height != "select") {
            ...
            //glassbracketrightPost='EP15 Glass Bracket For Right Post';
            glassbracketrightPost = 'EP15 Glass Bracket For Right Post ' + choose_finish_obj.value + '';
        ...
        if (height != "select") {
            leftanglePost = 'EP5-' + height + " End " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
            //glassbracketleftPost='EP15 Glass Bracket For Left Post';
            glassbracketleftPost = 'EP15 Glass Bracket For Left Post ' + choose_finish_obj.value + '';
                ...
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                            glassName = category_name + '-' + height + ' ' + face_lenght_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "round" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
        ...
        if (face_lenght_a_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                            glassName_a = category_name + '-' + height + ' ' + face_lenght_a_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "round" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                ...
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left") || (cornerPosition == "2nd Center Post from Left"))) {
                            glassName_b = category_name + '-' + height + ' ' + face_lenght_b_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "round" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                ...
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left") || (cornerPosition == "3rd Center Post from Left"))) {
                            glassName_c = category_name + '-' + height + ' ' + face_lenght_c_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "round" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                ...
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if ((form.posttype.value != "select") && (cornerPosition == "3rd Center Post from Left")) {
                            glassName_d = category_name + '-' + height + ' ' + face_lenght_d_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "round" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
            ...
            if (height != "select") {
                ...
                if (gotocornerpostss == "1") {
                    if (cornerPosition == "1st Center Post from Left") {
                        centerPost1 = category_name + "-" + height + " " + posttypegl + " Corner " + postdegreegl + " " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost2 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost3 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                    }
                    if (cornerPosition == "2nd Center Post from Left") {

                        centerPost2 = category_name + "-" + height + " " + posttypegl + " Corner " + postdegreegl + " " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost1 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost3 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                    }
                    if (cornerPosition == "3rd Center Post from Left") {
                        centerPost3 = category_name + "-" + height + " " + posttypegl + " Corner " + postdegreegl + " " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost1 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                        centerPost2 = category_name + "-" + height + " Center " + (choose_finish_obj.value == "Brushed Aluminum" ? "Brushed Aluminum" : "Post " + choose_finish_obj.value);
                    } else {
    ...
    if (height != "select") {
        ...
        if ((leftanglePost != "") || (rightanglePost != "") && category_name == "EP15") {
            i = 0;
            j = 0;
            if (glass_face_obj.value == 1) {
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[leftanglePost][0] + '" />';
                leftanglePostPrice = leftanglePostPrice + parseFloat(product_name_price[leftanglePost][1]);

                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassbracketleftPost][0] + '" />';
                glassbracketleftPostPrice = glassbracketleftPostPrice + parseFloat(product_name_price[glassbracketleftPost][1]);
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassbracketleftPost][0] + '" />';
                glassbracketleftPostPrice = glassbracketleftPostPrice + parseFloat(product_name_price[glassbracketleftPost][1]);

                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[rightanglePost][0] + '" />';
                rightanglePostPrice = rightanglePostPrice + parseFloat(product_name_price[rightanglePost][1]);

                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassbracketrightPost][0] + '" />';
                glassbracketrightPostPrice = glassbracketrightPostPrice + parseFloat(product_name_price[glassbracketrightPost][1]);
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassbracketrightPost][0] + '" />';
                glassbracketrightPostPrice = glassbracketrightPostPrice + parseFloat(product_name_price[glassbracketrightPost][1]);
    ...
    if (flangeCovers != "") {
        if (category_name == "EP15") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP15-FLANGE COVER 4 PIECES";
                    flangeCovers = "EP15-FLANGE COVER 1 PIECE";
                    ...
                    //flangeCovers="EP15-FLANGE COVER 3 PIECES";
                    flangeCovers = "EP15-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    ...
                    //flangeCovers="EP15-FLANGE COVER 2 PIECES";
                    flangeCovers = "EP15-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                ...
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP15-FLANGE COVER 5 PIECES";
                    flangeCovers = "EP15-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                ...
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP15-FLANGE COVER 6 PIECES";
                    flangeCovers = "EP15-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
        ...
        if ("EP15" == "EP15") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    ...
                    flangeUnderCounter = "EP15-UNDER COUNTER FLANGE 1 PIECE";
    ...
    t_post_price = centerPostPrice + leftanglePostPrice + glassbracketleftPostPrice + glassbracketrightPostPrice + rightanglePostPrice;
    ...
    if (type_obj.value == "2BAY" || type_obj.value == "3BAY" || type_obj.value == "4BAY") {
        ...
        if (type_obj.value == "4BAY") {
            document.getElementById("postimg1").src = "images/EP15/4BAY/" + imgpsorname1 + "";
            document.getElementById("postimg2").src = "images/EP15/4BAY/" + imgpsorname2 + "";
            document.getElementById("postimg3").src = "images/EP15/4BAY/" + imgpsorname3 + "";
        }
        if (type_obj.value == "3BAY") {
            document.getElementById("postimg1").src = "images/EP15/3BAY/" + imgpsorname1 + "";
            document.getElementById("postimg2").src = "images/EP15/3BAY/" + imgpsorname2 + "";
        }
        if (type_obj.value == "2BAY") {
            document.getElementById("postimg1").src = "images/EP15/2BAY/" + imgpsorname1 + "";
        }
    ...
    if (zero && one && two && three && four && five && six && seven && eight) {} else {}
...
function getProductFolderName(productname) {
    ...
    switch (productname) {
        case 'EP15':
            {
                foldername = "EP-15"; //getting the resource images from the perticular folder
                break;
            }
...
function changeGlassImage(form, image) {
    ...
    category_name = "EP15";
    foldername = getProductFolderName("EP15") + form.type.value;
    imageName = '';
...
function finishImage(form, image) {
    category_name = "EP15";
    foldername = getProductFolderName("EP15");
    if (image != "") {
        imageName = image;
    }
...
function myFunction2(form) {
    ...
    var gotocorner = $("input[name='gotocornerpostcheck']:checked").val();

    if (myFunction(document.forms['cart_quantity'])) {
        var bay = form.type.value;

        //var var1L=var1T=var2L=var2

        //alert($(".glass_a").css("top"));
        //alert($(".glass_a").css("left"));

        var var1 = var2 = var3 = var4 = var5 = var6 = var7 = var8 = var9 = var10 = var11 = flange = "";
...
function jsconfirm($msg, category_name, ispost, custom, post, panel) {
    $.confirm({
        'title': 'Confirmation',
        'message': $msg,
        'buttons': {
            'Proceed': {
                ...
                'action': function() {
                    ...
                    if ((post == 'yes') && (category_name == 'EP15')) {

                        var j = 0;
                        for (i = 18; i < 22; i++) {
                            if (i == 18) {
                                my_facelengt_select += '<option value="' + 18 + '">' + i + '"</option>';
                            } else {
