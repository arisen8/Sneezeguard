...
function finishImage(form, image) {
    category_name = "ES92";
    foldername = getProductFolderName("ES92");
    if (image != "") {
        imageName = image;
    }
...
function changeGlassImage(form, image) {
    category_name = "ES92";
    foldername = getProductFolderName("ES92") + form.type.value;
    imageName = '';
...
function getPriceOfProductES92(form, osc, im_id) {
    t1 = 0;
    ...
    tube_c = "";
    tube_d = "";
    adjustable_name = "ES92 Adjustable Brackets (Pairs)";
    ...
    flangCoversPrice = 0;
    supportPostPrice = 0; //support-post
    ...
    if (left_lenght_obj.value != "select") {
        if (type_obj.value == '2BAYEXT') {
            leftEndPost = c_name + 'EXTLP' + choose_finish_obj.value;
            ...
            rightEndPost = c_name + 'EXTRP' + choose_finish_obj.value;
            ...
            if (type_obj.value != "1BAY") {
                if (left_lenght_obj.value != "select") {
                    centerPost = c_name + 'EXTCP' + choose_finish_obj.value;
                }
            }
        } else {
    ...
    if (type_obj.value == "4BAY") {
        if (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass' || face_lenght_c_obj.value == 'No Glass' || face_lenght_d_obj.value == 'No Glass') {
            ...
            if (face_lenght_a_obj.value != "select") {
                glassName_a = c_name + "-" + face_lenght_a_obj.value + "GL-RND";
                if (rounded_corners_obj.value == "round") {
                    glassName_a = glassName_a + "GL-RND";
                }
                ...
                if (left_lenght_obj.value != "select") {
                    topGlass_a = c_name + "-" + face_lenght_a_obj.value + "/" + left_lenght_obj.value + "TG-RND";
                    if (rounded_corners_obj.value == "round") {
                        topGlass_a = topGlass_a + "TG-RND";
                    }
            ...
            if (face_lenght_b_obj.value != "select") {
                glassName_b = c_name + "-" + face_lenght_b_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_b = glassName_b + "GL-RND";
                }
                ...
                if (left_lenght_obj.value != "select") {
                    topGlass_b = c_name + "-" + face_lenght_b_obj.value + "/" + left_lenght_obj.value + "TG-RND";
                    if (rounded_corners_obj.value == "round") {
                        topGlass_b = topGlass_b + "TG-RND";
                    }
            ...
            if (face_lenght_c_obj.value != "select") {
                glassName_c = c_name + "-" + face_lenght_c_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_c = glassName_c + "GL-RND";
                }
                ...
                if (left_lenght_obj.value != "select") {
                    topGlass_c = c_name + "-" + face_lenght_c_obj.value + "/" + left_lenght_obj.value + "TG-RND";
                    if (rounded_corners_obj.value == "round") {
                        topGlass_c = topGlass_c + "TG-RND";
                    }
            ...
            if (face_lenght_d_obj.value != "select") {
                glassName_d = c_name + "-" + face_lenght_d_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_d = glassName_d + "GL-RND";
                }
                ...
                if (left_lenght_obj.value != "select") {
                    topGlass_d = c_name + "-" + face_lenght_d_obj.value + "/" + left_lenght_obj.value + "TG-RND";
                    if (rounded_corners_obj.value == "round") {
                        topGlass_d = topGlass_d + "TG-RND";
                    }
        ...
        if (face_lenght_obj.value == 'No Glass') {
            // if(rounded_corners_obj.value!=0){
            // 	alert("No GLASS with rounded checked");
            // }else{
            // 	alert("No GLASS with rounded unchecked");
            // }
            flag = 0;
            form.flange_covers.value = "no";
            form.flange_covers.selected = "No";
            ...
            if (face_lenght_obj.value != "select") {
                glassName_a = c_name + "-" + face_lenght_obj.value + "GL-RND";
                if (rounded_corners_obj.value == "round") {
                    glassName_a = glassName_a + "GL-RND";
                }
                //alert(left_lenght_obj.value);
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassName_a][0] + '" />';
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[glassName_a][0] + '" />';
                facePrice_a = parseFloat(2 * product_name_price[glassName_a][1]);
                if (left_lenght_obj.value != "select") {
                    topGlass_a = c_name + "-" + face_lenght_obj.value + "/" + left_lenght_obj.value + "TG-RND";
                    if (rounded_corners_obj.value == "round") {
                        topGlass_a = topGlass_a + "TG-RND";
                    }
                    topGlassPrice_a = parseFloat(product_name_price[topGlass_a][1]);
    ...
    if (flange_covers_obj.value == "yes") {
        if (type_obj.value == "4BAY") {
            ...
            if (face_lenght_a_obj.value != "select") {
                light_a = c_name + "-" + face_lenght_a_obj.value + "LYTEXT";

                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_a][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_a][1]);
            }
            if (face_lenght_b_obj.value != "select") {
                light_b = c_name + "-" + face_lenght_b_obj.value + "LYTEXT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_b][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_b][1]);
            }
        } else {
    ...
    if (type_obj.value == "4BAY") {
        if (face_lenght_a_obj.value != "select") {
            tube_a = "ES92-" + face_lenght_a_obj.value + "TUBE";
        ...
        if (face_lenght_b_obj.value != "select") {
            tube_b = "ES92-" + face_lenght_b_obj.value + "TUBE";
        ...
        if (face_lenght_c_obj.value != "select") {
            tube_c = "ES92-" + face_lenght_c_obj.value + "TUBE";
        ...
        if (face_lenght_d_obj.value != "select") {
            tube_d = "ES92-" + face_lenght_d_obj.value + "TUBE";
        ...
        if (face_lenght_obj.value != "select") {
            tube_a = "ES92-" + face_lenght_obj.value + "TUBE";
            //str+='<input type="hidden" name="products_id[]" value="'+product_name_price[tube_a][0]+'" />';
            flangeCoversPrice3 += parseFloat(product_name_price[tube_a][1]);
        }
        tube_b = "";
    ...
    if (flang_covers_obj.value == "yes") {
        flangCovers = "ES92-FLANGE COVER 1 PIECE";
        if (type_obj.value == "4BAY") {
    ...
    if (flange_under_counter_obj.value == "yes") {
        flangeUnderCounter = "ES92-UNDER COUNTER FLANGE 1 PIECE";
        if (type_obj.value == "4BAY") {
    ...
    supportPost = 'ES92 SUPPORT POST ' + choose_finish_obj.value;
    ...
    if (flag) {
        ...
        if (choose_finish_obj.value == "SS") {
            imageName = "NOGLROUND" + imageName;
        } else if (choose_finish_obj.value == "PC") {
            imageName = "NOGLBLACKROUND" + imageName;
        } else if (choose_finish_obj.value == "AL") {
            imageName = "NOGLALMNROUND" + imageName;
        }
    ...
    //     if(choose_finish_obj.value=="SS"){
    //          if(flange_covers_obj.value!=0 && rounded_corners_obj.value==0){
    //             imageName=imageName;
    //         }else if(flange_covers_obj.value!=0 && rounded_corners_obj.value!=0 && flag!=0){
    // 		imageName="RUND"+imageName;
    //  	}else if(flange_covers_obj.value==0 && rounded_corners_obj.value!=0 && flag!=0){
    //  		imageName="ROUNDRUND"+imageName;
    //  		//alert(imageName);
    //  	}else{
    ...
    //  	} else if(flange_covers_obj.value==0 && rounded_corners_obj.value!=0 && flag!=0){
    //  		imageName="BLACKROUNDRUND"+imageName;
    //  	} else{
    //             imageName="BLACKROUND"+imageName;
    //  	}
    //     }else if(choose_finish_obj.value=="AL"){
    ...
    //  	}else if(flange_covers_obj.value==0 && rounded_corners_obj.value!=0 && flag!=0){
    //  		imageName="ALMNROUNDRUND"+imageName;
    //  	}else{
    //             imageName="ALMNROUND"+imageName;
    //         }
    //  }
    ...
    document.getElementById('additional_image').innerHTML = image_string;
    var coutw = right_lenght_obj.value;
    var innew = right_lenght_obj.value - 15.75;
    var gttt = (parseInt(right_lenght_obj.value) - 2.25);

    if (innew == "8.25") { var final_inner = "8-1/4"; }
    if (innew == "9.25") { var final_inner = "9-1/4"; }
    if (innew == "10.25") { var final_inner = "10-1/4"; }
    if (innew == "11.25") { var final_inner = "11-1/4"; }
    if (innew == "12.25") { var final_inner = "12-1/4"; }
    if (innew == "13.25") { var final_inner = "13-1/4"; }
    if (innew == "14.25") { var final_inner = "14-1/4"; }
    if (innew == "15.25") { var final_inner = "15-1/4"; }
    if (innew == "16.25") { var final_inner = "16-1/4"; }
    if (innew == "17.25") { var final_inner = "17-1/4"; }
    if (innew == "18.25") { var final_inner = "18-1/4"; }
    if (innew == "19.25") { var final_inner = "19-1/4"; }
    if (innew == "20.25") { var final_inner = "20-1/4"; }
    if (innew == "21.25") { var final_inner = "21-1/4"; }
    if (innew == "22.25") { var final_inner = "22-1/4"; }
    if (innew == "23.25") { var final_inner = "23-1/4"; }
    if (innew == "24.25") { var final_inner = "24-1/4"; }
    if (innew == "25.25") { var final_inner = "28-1/4"; }
    if (innew == "26.25") { var final_inner = "26-1/4"; }
    if (innew == "27.25") { var final_inner = "27-1/4"; }
    if (innew == "28.25") { var final_inner = "28-1/4"; }
    if (innew == "29.25") { var final_inner = "29-1/4"; }
    if (innew == "30.25") { var final_inner = "30-1/4"; }
    if (innew == "31.25") { var final_inner = "31-1/4"; }
    if (innew == "32.25") { var final_inner = "32-1/4"; }
    if (innew == "33.25") { var final_inner = "33-1/4"; }
    if (innew == "34.25") { var final_inner = "34-1/4"; }
    if (innew == "35.25") { var final_inner = "35-1/4"; }
    if (innew == "36.25") { var final_inner = "36-1/4"; }
    if (innew == "37.25") { var final_inner = "37-1/4"; }
    if (innew == "38.25") { var final_inner = "38-1/4"; }

    if (gttt == "21.75") { var final_gttt = "21-3/4"; }
    if (gttt == "22.75") { var final_gttt = "22-3/4"; }
    if (gttt == "23.75") { var final_gttt = "23-3/4"; }
    if (gttt == "24.75") { var final_gttt = "24-3/4"; }
    if (gttt == "25.75") { var final_gttt = "25-3/4"; }
    if (gttt == "26.75") { var final_gttt = "26-3/4"; }
    if (gttt == "27.75") { var final_gttt = "27-3/4"; }
    if (gttt == "28.75") { var final_gttt = "28-3/4"; }
    if (gttt == "29.75") { var final_gttt = "29-3/4"; }
    if (gttt == "30.75") { var final_gttt = "30-3/4"; }
    if (gttt == "31.75") { var final_gttt = "31-3/4"; }
    if (gttt == "32.75") { var final_gttt = "32-3/4"; }
    if (gttt == "33.75") { var final_gttt = "33-3/4"; }
    if (gttt == "34.75") { var final_gttt = "34-3/4"; }
    if (gttt == "35.75") { var final_gttt = "35-3/4"; }
    if (gttt == "36.75") { var final_gttt = "36-3/4"; }
    if (gttt == "37.75") { var final_gttt = "37-3/4"; }
    if (gttt == "38.75") { var final_gttt = "38-3/4"; }
    if (gttt == "39.75") { var final_gttt = "39-3/4"; }
    if (gttt == "40.75") { var final_gttt = "40-3/4"; }
    if (gttt == "41.75") { var final_gttt = "41-3/4"; }
    if (gttt == "42.75") { var final_gttt = "42-3/4"; }
    if (gttt == "43.75") { var final_gttt = "43-3/4"; }
    if (gttt == "44.75") { var final_gttt = "44-3/4"; }
    if (gttt == "45.75") { var final_gttt = "45-3/4"; }
    if (gttt == "46.75") { var final_gttt = "46-3/4"; }
    if (gttt == "47.75") { var final_gttt = "47-3/4"; }
    if (gttt == "48.75") { var final_gttt = "48-3/4"; }
    if (gttt == "49.75") { var final_gttt = "49-3/4"; }
    if (gttt == "50.75") { var final_gttt = "50-3/4"; }
    if (gttt == "51.75") { var final_gttt = "51-3/4"; }

    if (glass_face_obj.value == 1) {
        //$("div.left").text(left_lenght_obj.value+'"');
        if (right_lenght_obj.value != "select") {
            $("div.right").text(final_inner + '"');
            $("div.left").text(final_gttt + '"');
        } else {
            $("div.right").text("Inner Width");
            $("div.left").text("Glass Tip to Tip");
        }
    ...
    if (type_obj.value == "2BAY" || type_obj.value == '2BAYEXT') {
        ...
        if (total == '2"') {
            ...
            /*
            //var totalsplit = "How are you doing today?";
            var totalsplit = total.split("-");
            var val11s=(parseInt(totalsplit[0])-2);
            //alert(total);
            if(totalsplit.includes("-"))
            {
            var secys='-'+totalsplit[1]+'';	
            }
            else{
            var secys='';	
            }
