    ...
    <tr>
        <td>
               ...
               <tr>
	                ...
	                <tr id="right_lenght">
	                    <td>
	                    	<a class="thickbox" href='images/ES92/Depth.jpg'><h1 >Countertop Width</h1></a>
	                    </td>
	                    <td>
				...
				<?php 
      			...
      			?>  
      						<tr class="test-length">
                    			<td class="test-lenght1bay" ><a class="thickbox" href='images/ES92/1bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                    			<td>
    				...
    				if($_REQUEST['type']=='3BAY'){
       					?> <tr class="test-length">
                			<td class="test-lenght3baya"><a class="thickbox" href='images/ES92/3bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                			<td>
								<span id="face_length_a_span">
                    				<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >	
									<?php
				    ...
				    <tr class="test-length">
                		<td class="test-lenght3bayb"><a class="thickbox" href='images/ES92/3bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                		<td>
							<span id="face_length_b_span">
                    			<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
                        			<?php
            		...
            		<tr class="test-length">
                		<td class="test-lenght3bayc"><a class="thickbox" href='images/ES92/3bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                		<td>
  					...
  					<?  } if($_REQUEST['type']=='4BAY'){
      					?> <tr class="test-length">
                				<td class="test-lenght4baya"><a class="thickbox" href='images/ES92/4bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                				<td>
									<span id="face_length_a_span">
                    					<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
        				    ...
        				    <tr class="test-length">
                				<td class="test-lenght4bayb"><a class="thickbox" href='images/ES92/4bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                				<td>
									<span id="face_length_b_span">
                    					<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
                        					<?php
    			        ...
    			        <tr class="test-length">
                			<td class="test-lenght4bayc"><a class="thickbox" href='images/ES92/4bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                			<td>
								<span id="face_length_c_span">
                    				<select name="face_length_c" id="face_length_c" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
                        				<?php
					...
					<tr class="test-length">
        		        <td class="test-lenght4bayd"><a class="thickbox" href='images/ES92/4bay_faceD.jpg'><h1>Face Length D</h1></a></td>
        		        <td>
		  ...
		  <table class="test-round" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
            	<tr>
                	...
                	<tr>
                        <td>
                            <a class="thickbox" href="images/ES92/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td>
		...
		<table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
					...
					<tr>
                        <td class="test-adjust1"><a class="thickbox" href="images/ES92/support_post.jpg"><h1>Support Post</h1></a></td>
                        <td>
...
<script src="includes/model_files/ES92/ES92.js"></script>
<script type="text/javascript">
	...
	function getPriceOfProduct(data){
		getPriceOfProductES92(data,osc,im_id);
	}
</script>
