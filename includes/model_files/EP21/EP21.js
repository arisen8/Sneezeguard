function getPriceOfProduct(form) {
    ...
    lightPrice_c = 0;
    lightPrice_d = 0;
    adjustable_name = "EP21 Adjustable Brackets (Pairs)";
        ...
        if (category_name == "EP5" || category_name == "EP15") {
            ...
            if (end_options_type_obj.value == "extended") {
                ...
                if (left_lenght_obj.value != 'select') {
                    leftEndPanel = 'EP21 ' + left_lenght_obj.value + '" EXT Left End Panel';
                }
                if (right_lenght_obj.value != 'select') {
                    rightEndPanel = 'EP21 ' + right_lenght_obj.value + '" EXT Right End Panel';
                }
    ...
    if (flangeCovers != "") {
        if (category_name == "EP21") {

            if (type_obj.value == "1BAY") {

                //flangeCovers="EP5-FLANGE COVER 2 PIECES";
                flangeCovers = "EP21-FLANGE COVER 1 PIECE";
    ...
    if (flangeUnderCounter != "") {
        ...
        if (category_name == "EP21") {
            ...
            if (type_obj.value == "1BAY") {
                flangeUnderCounter = "EP21-UNDER COUNTER FLANGE 1 PIECE";
    ...
    if (gotocornerpost == "1") {
        if (type_obj.value == "4BAY") {
            if (face_lenght_d_obj.value != "No Glass" || face_lenght_c_obj.value != "No Glass" || face_lenght_b_obj.value != "No Glass" || face_lenght_a_obj.value != "No Glass") {
                lightBracket = "EP21-Light Bracket";
                if (flange_covers2_obj.value == "yes") {
                    if (lightBracket != "") {
    ...
    if (type_obj.value == "2BAY" || type_obj.value == "3BAY" || type_obj.value == "4BAY") {
        ...
        if (noofcornerpostval == 2) {
            if (type_obj.value == "4BAY") {
                document.getElementById("postimg12").src = "images/EP21/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg23").src = "images/EP21/4BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg12").src = "images/EP21/3BAY/" + imgpsorname1 + "";
            }
        } else {

            if (type_obj.value == "4BAY") {
                document.getElementById("postimg1").src = "images/EP21/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP21/4BAY/" + imgpsorname2 + "";
                document.getElementById("postimg3").src = "images/EP21/4BAY/" + imgpsorname3 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg1").src = "images/EP21/3BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP21/3BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "2BAY") {
                document.getElementById("postimg1").src = "images/EP21/2BAY/" + imgpsorname1 + "";
            }
    ...
    if (category_name == "EP12" && type_obj.value == "1BAY") {
        ...
        $('.post').css("right", "56px");
        $('.post').text('17-1/4"');
        if (post_height_obj.value != 'custom' && face_lenght_obj.value == 'No Glass') { $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text); } else { $('.post').text('17-1/4"'); }
    }
    if (category_name == "EP11" && type_obj.value == "2BAY") {
        ...
        $('.post').css("left", "485px");
        $('.post').text('17-1/4"');
        if (post_height_obj.value != 'custom' && face_lenght_a_obj.value == 'No Glass') { $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text); }
    }
    if (category_name == "EP11" && type_obj.value == "3BAY") {
        ...
        $('.post').css("left", "524px");
        $('.post').text('17-1/4"');
        if (post_height_obj.value != 'custom' && face_lenght_c_obj.value == 'No Glass') { $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text); }
    }
    ...
    if (category_name == "EP12" && type_obj.value == "4BAY") {
        ...
        $('.post').css("left", "537px");
        $('.post').text('17-1/4"');
        if (post_height_obj.value != 'custom' && face_lenght_d_obj.value == 'No Glass') { $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text); }
    }
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "1BAY") {
        $('.post').css("top", "110px");
        $('.post').css("right", "56px");
        $('.glass').css("left", "367px").css("top", "300px");
        $('.total').css("bottom", "105px")
        $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
        $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
    }
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "3BAY") {
        $('.post').css("top", "89px");
        $('.post').css("left", "537px");
        $('.glass_a').css("bottom", "148px").css("left", "196px");
        $('.glass_b').css("bottom", "226px").css("left", "369px");
        $('.glass_c').css("bottom", "275px").css("left", "488px");
        $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
        $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
    }
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "4BAY") {
        $('.post').css("top", "89px");
        $('.post').css("left", "537px");
        $('.glass_a').css("bottom", "135px").css("left", "160px");
        $('.glass_b').css("bottom", "201px").css("left", "316px");
        $('.glass_c').css("bottom", "275px").css("left", "488px");
        $('.glass_d').css("bottom", "300px").css("left", "488px");
        $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
        $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
    }
