        ...
        <td>
                               ...
                               <div class="tables-options"  id="hidetable1">         
                                <table cellpadding="0" cellspacing="0" width="100%" style="" >
                                    ...
                                    <tr>
                    <td width="40%">
                        <a class="thickbox" href='images/EP11/Post_height.jpg'><h1>Post Height</h1></a>
                    </td>
                    <td width="50%">
		  ...
		  <table cellpadding="0" cellspacing="0" width="100%" style="" >
					...
					?>
                    <tr>
                        <td colspan=3><center><h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;2)</span>Options</center></h2></td>
                    </tr>
                    <tr>
                        <td width="40%">
                            <a class="thickbox" href="images/EP11/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td width="50%">
					...
					<tr id="right_lenght" style="display:none;">
                                        <td width="40%"><a class="thickbox" href='images/EP11/Right_length.jpg' ><h1 style="margin-left:20px;">Right Length</h1></a></td><td width="50%">
                                    ...
                                    <tr id="left_lenght" style="display:none;">
                                        <td width="40%"><center><a class="thickbox" href='images/EP11/Left_length.jpg' ><h1 style="margin-left:20px;">Left Length</h1></a></center></td><td>
					...
					<tr>
                        <td width="40%">
                            <a class="thickbox" href="images/EP11/End_panels.jpg"><h1>End Panel Type</h1></a>
                        </td>
                        <td width="50%">
                    ...
                    <tr>
                    <td class="test-flang" width="40%"><a class="flange-covers-pricing"><h1>Flange Covers</h1></a></td>
                        <td width="50%">
                    ...
                    <tr style="display:none;">
                        <td class="test-flang" width="40%"><div style="position: relative; height:27px;"><a class="thickbox" href='flang_under_counter.php?type=adj&KeepThis=true&TB_iframe=true&height=480&width=640'><h1>Flange Under Counter</h1></a></td>
                        <td width="50%">
                    ...
                    <tr>
                    <td class="test-light" width="40%"><a class="light-bar-pricing" data-model-name="<?=$category_name;?>"><h1>Light Bar</h1></a></td>
                        <td width="50%">
		...
		<div class="tables-options" id="hidetable3">
          ...
          <table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    ...
                    <td width="40%"><a class="adjustable-brackets-pricing" ><h1>Adjustable Brackets</h1></a></td>
                        <td width="50%">
                            <select class="makeadjustablecheck31" name="adjustable" style="" align="right" onchange="makeAdjustable(this.form);getPriceOfProduct(this.form);">
                                <option value="no">No</option>
                                <option value="yes">Yes</option>
                            </select>
                        </td>
...
?>
				...
				<tr>
                        <td><a class="thickbox" href='images/EP11/post_type.jpg'><h1 style="text-decoration: none;">No of Corner Post</h1></a></td>
                        <td>
				...
				?>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP11/post_type.jpg'><h1 style="text-decoration: none;">Corner Post Type</h1></a></td>
                        <td>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP11/post_degree.jpg'><h1 style="text-decoration: none;">Corner Post Angle</h1></a></td>
                        <td>
				...
				<table id="showtable2" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
				   ...
				   <img src="images/EP11/2BAY/INNER90D1STPOST.jpg" id="postimg1" /></a></label></td>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP11/3BAY/INNER90D1STPOST.jpg" id="postimg1" /></a></label></td>
				   ...
				   <img src="images/EP11/3BAY/INNER90D2NDPOST.jpg" id="postimg2" style="width:90%;" /></a></label></td>
				   </tr>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP11/4BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   <td style="padding-left:5px;"><label>
				   <input type="radio" name="corner_post" id="2ndcenter" onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
				   <img src="images/EP11/4BAY/INNER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
				   ...
				   <img src="images/EP11/4BAY/INNER90D3RDPOST.jpg" id="postimg3"  /></label></td>
			...
			<div id="cart-form"  class="tables-options forgotot11">
				...
				<table id="forgotot" cellpadding="0" align="center" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    ...
                    <tr>
                        <td colspan="3"><center><h3 class="btspl"><a style="color:#000000;">
						...
						<label for="gotocornerpostcheck" data-bay="<?=$_GET['type']?>" id="gotocornerpost" style="text-align:center !important;float:left;"><span class="heading_all"><span style="float:left;">&nbsp;&nbsp;4)</span></span>Go To Corner Post <span class="blink"><blink><b>New!</b></blink></span><center></label>
						</a>
						</h3></td>
                    </tr>
					</table>
				...
				<table id="forstarightpost" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px; display:none;">
                    <tr>
						...
						<label for="gotocornerpostcheck"  style="float:left;"><span class="heading_all"><span >&nbsp;&nbsp;3)</span></span>&nbsp;&nbsp;&nbsp;Back To Straight Post</label><h3></a></center></td>
                    </tr>
					</table>
...
<!-- ani code -->
        ...
        <input type="hidden" id="c_glass_right_val" name="c_glass_right_val_ep11" value=""  />
        ...
        <input type="hidden" id="c_glass_left_val" name="c_glass_left_val_ep11" value=""  />
...
<script>
		...
		var add_more_bay='<?php echo$add_more_bay ?>';
...
<script src="includes/model_files/EP11/EP11.js"></script>