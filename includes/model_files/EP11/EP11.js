    ...
    $('#gotocornerpost').click(function() {
        if (screen.width >= 992 && screen.width <= 1024) {
            if ($(this).data('bay') == '2BAY') {
                ...
                $('.icons-quotes2').css('margin-top', '-8.75rem');
            } else if ($(this).data('bay') == '4BAY') {
                $('.icons-quotes2').css('margin-top', '-14.75rem');
            }
        }
...
function getPriceOfProduct(form) {
    ...
    lightPrice_c = 0;
    lightPrice_d = 0;
    adjustable_name = "EP11 Adjustable Brackets (Pairs)";
    ...
    if (glass_face_obj.value == 1) {
        ...
        if (end_options_type_obj.value == "extended") {
            ...
            //leftEndPanel=category_name+' EXT Left End'+(category_name=="EP11"?" Panel":"");
            //rightEndPanel=category_name+' EXT Right End'+(category_name=="EP11"?" Panel":"");
            if (left_lenght_obj.value != 'select') {
                leftEndPanel = 'EP11 ' + left_lenght_obj.value + '" EXT Left End Panel';
            }
            if (right_lenght_obj.value != 'select') {
                rightEndPanel = 'EP11 ' + right_lenght_obj.value + '" EXT Right End Panel';
            }
                    ...
                    if (gotocornerpostss == "1") {
                        if (noofcornerpostval == 2) {
                            if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                                ...
                                light_a = category_name + "-" + face_lenght_a_obj.value + "LYT";
                                //old code...   
                                //light_a=category_name+"-"+face_lenght_a_obj.value+"LYT "+posttypegl+" "+postdegreegl+"";	
                            }
                    ...
                    if (gotocornerpostss == "1") {
                        ...
                        if (noofcornerpostval == 2) {
                            if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                                ...
                                glassName_a = category_name + '-' + height + ' ' + face_lenght_a_obj.value + '" Glass ' + posttypegl + ' ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            }
    ...
    if (flangeCovers != "") {
        ...
        if (category_name == "EP11") {
            ...
            if (type_obj.value == "1BAY") {
                // flangeCovers="EP11-FLANGE COVER 2 PIECEs";
                flangeCovers = "EP11-FLANGE COVER 1 PIECE";
    ...
    if (flangeUnderCounter != "") {
        ...
        if (category_name == "EP11") {
            ...
            if (type_obj.value == "1BAY") {
                flangeUnderCounter = "EP11-UNDER COUNTER FLANGE 1 PIECE";
    ...
    if (gotocornerpost == "1") {
        if (type_obj.value == "4BAY") {
            if (face_lenght_d_obj.value != "No Glass" || face_lenght_c_obj.value != "No Glass" || face_lenght_b_obj.value != "No Glass" || face_lenght_a_obj.value != "No Glass") {
                lightBracket = "EP11-Light Bracket";
                if (flange_covers2_obj.value == "yes") {
                    if (lightBracket != "") {
    ...
    if (type_obj.value == "2BAY" || type_obj.value == "3BAY" || type_obj.value == "4BAY") {
        ...
        if (noofcornerpostval == 2) {
            if (type_obj.value == "4BAY") {
                document.getElementById("postimg12").src = "images/EP11/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg23").src = "images/EP11/4BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg12").src = "images/EP11/3BAY/" + imgpsorname1 + "";
            }
        } else {
            if (type_obj.value == "4BAY") {
                document.getElementById("postimg1").src = "images/EP11/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP11/4BAY/" + imgpsorname2 + "";
                document.getElementById("postimg3").src = "images/EP11/4BAY/" + imgpsorname3 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg1").src = "images/EP11/3BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP11/3BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "2BAY") {
                document.getElementById("postimg1").src = "images/EP11/2BAY/" + imgpsorname1 + "";
            }
    ...
    if (category_name == "EP11" && type_obj.value == "1BAY") {
    ...
    if (category_name == "EP11" && type_obj.value == "2BAY") {
        if (post_height_obj.value != "select") {
            $(".msgtishu2").css("display", "none");
    ...
    if (category_name == "EP11" && type_obj.value == "3BAY") {
        if (post_height_obj.value != "select") {
            $(".msgtishu2").css("display", "none");
    ...
    if (category_name == "EP11" && type_obj.value == "4BAY") {
        if (post_height_obj.value != "select") {
            $(".msgtishu2").css("display", "none");
    ...
    if (category_name == "EP11" && iscustomimg == 1 && type_obj.value == "1BAY") {
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP11" && iscustomimg == 1 && type_obj.value == "2BAY") {
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP11" && iscustomimg == 1 && type_obj.value == "3BAY") {
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP11" && iscustomimg == 1 && type_obj.value == "4BAY") {
        if (post_height_obj.value != "select") {
    ...
    document.getElementById("total").innerHTML = "$&nbsp" + totalPrice + ".00";
...
function myFunction(form) {
    ...
    // if(form.flange_under_counter.value=="select"){
    // x+='<li>Flange Under Counter <span style="color:red">?</span></li>';
    // check=false;
    // }
            ...
            success: function(data, textStatus, request) {
                ...
                /*
						 if(gotocornerpostss=="1")
						{
							...
							$.confirm({
								'title'     : 'Confirmation',
					'message'   : '<p><span><span style="color: #ff0000;">Do you want to add more bays in this order</span> </span></p><p><span>Do you want to add more bays in current order please click on purcahse button</span></p><p><span><span></span></span></p>',
					'buttons'   : {
						'Proceed'   : {
							'class' : 'blue',
							'action': function(){
