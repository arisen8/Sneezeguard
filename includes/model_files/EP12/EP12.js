function getPriceOfProduct(form) {
    ...
    lightPrice_c = 0;
    lightPrice_d = 0;
    adjustable_name = "EP12 Adjustable Brackets (Pairs)";
    ...
    //var lwellw=end_options_type_obj.value;
    //alert(lwellw);
        ...
        if (category_name == "EP5" || category_name == "EP15") {
            ...
            if (end_options_type_obj.value == "extended") {
                ...
                if (left_lenght_obj.value != 'select') {
                    leftEndPanel = category_name + ' ' + left_lenght_obj.value + '" EXT Left End' + (category_name == "EP11" ? " Panel" : "");
                }

                if (right_lenght_obj.value != 'select') {
                    rightEndPanel = category_name + ' ' + right_lenght_obj.value + '" EXT Right End' + (category_name == "EP11" ? " Panel" : "");
                }
    ...
    if (face_lenght_obj != null && face_lenght_obj.value != "select") {
        if (face_lenght_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                glassName = category_name + '-' + height + ' ' + face_lenght_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                ...
                if (gotocornerpostss == "1") {
                    if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                        glassName = category_name + ' ' + face_lenght_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                    } else {
                        glassName = category_name + ' ' + face_lenght_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                    }
            ...
            if (category_name == 'EP12' && (post_height_obj.value != 'Instock') && (post_height_obj.value != 'custom')) {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                            glassName = category_name + '-' + height + ' ' + face_lenght_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                            glassName = category_name + '-' + height + ' ' + face_lenght_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        }
    ...
    if (face_lenght_a_obj != null && face_lenght_a_obj.value != "select") {
        if (face_lenght_a_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                glassName_a = category_name + '-' + height + ' ' + face_lenght_a_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                if (flange_covers2_obj.value == "yes") {
                ...
                if (gotocornerpostss == "1") {
                    ...
                    if (noofcornerpostval == 2) {
                        if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                            ...
                            glassName_a = category_name + ' ' + face_lenght_a_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                            glassName_a = category_name + ' ' + face_lenght_a_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        }
                    } else {
            ...
            if (category_name == 'EP12' && (post_height_obj.value != 'Instock') && (post_height_obj.value != 'custom')) {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        ...
                        if (noofcornerpostval == 2) {
                            if ((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left")) {
                                glassName_a = category_name + '-' + height + ' ' + face_lenght_a_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            } else {
                                glassName_a = category_name + '-' + height + ' ' + face_lenght_a_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
    ...
    if (face_lenght_b_obj != null && face_lenght_b_obj.value != "select") {
        if (face_lenght_b_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                glassName_b = category_name + '-' + height + ' ' + face_lenght_b_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                if (flange_covers2_obj.value == "yes") {
                ...
                if (gotocornerpostss == "1") {
                    ...
                    if (noofcornerpostval == 2) {
                        ...
                        if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left"))) {
                            glassName_b = category_name + ' ' + face_lenght_b_obj.value + '" Glass ' + posttypegl + ' Two Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");

                        } else if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left"))) {
                            glassName_b = category_name + ' ' + face_lenght_b_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                            glassName_b = category_name + ' ' + face_lenght_b_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        }
            ...
            if (category_name == 'EP12' && (post_height_obj.value != 'Instock') && (post_height_obj.value != 'custom')) {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        ...
                        if (noofcornerpostval == 2) {
                            if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left"))) {
                                glassName_b = category_name + '-' + height + ' ' + face_lenght_b_obj.value + '" Glass ' + posttypegl + ' Two Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");

                            } else if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left"))) {
                                glassName_b = category_name + '-' + height + ' ' + face_lenght_b_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            } else {
                                glassName_b = category_name + '-' + height + ' ' + face_lenght_b_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            }
                        } else {
    ...
    if (face_lenght_c_obj != null && face_lenght_c_obj.value != "select") {
        if (face_lenght_c_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                glassName_c = category_name + '-' + height + ' ' + face_lenght_c_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                if (flange_covers2_obj.value == "yes") {
                ...
                if (gotocornerpostss == "1") {
                    ...
                    if (noofcornerpostval == 2) {
                        if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left"))) {
                            glassName_c = category_name + ' ' + face_lenght_c_obj.value + '" Glass ' + posttypegl + ' Two Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");

                        } else if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left"))) {
                            glassName_c = category_name + ' ' + face_lenght_c_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        } else {
                            glassName_c = category_name + ' ' + face_lenght_c_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        }
                    ...
                    if (gotocornerpostss == "1") {
                        ...
                        if (noofcornerpostval == 2) {
                            if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left"))) {
                                ...
                                //old code
                                //light_c=category_name+"-"+face_lenght_c_obj.value+"LYT "+posttypegl+" Corner Two "+postdegreegl+"";
                            } else {
                                light_c = category_name + "-" + face_lenght_c_obj.value + "LYT";
                            }
                        } else {
            ...
            if (category_name == 'EP12' && (post_height_obj.value != 'Instock') && (post_height_obj.value != 'custom')) {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        if (noofcornerpostval == 2) {
                            if (((form.posttype.value != "select") && (cornerPosition == "1st Center Post from Left"))) {
                                glassName_c = category_name + '-' + height + ' ' + face_lenght_c_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");

                            } else if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left"))) {
                                glassName_c = category_name + '-' + height + ' ' + face_lenght_c_obj.value + '" Glass ' + posttypegl + ' Two Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            } else {
                                glassName_c = category_name + '-' + height + ' ' + face_lenght_c_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            }
                        } else {
    ...
    if (face_lenght_d_obj != null && face_lenght_d_obj.value != "select") {
        ...
        if (face_lenght_d_obj.value != "No Glass") {
            if (category_name == "EP5" || category_name == "EP15") {
                glassName_d = category_name + '-' + height + ' ' + face_lenght_d_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                if (flange_covers2_obj.value == "yes") {
                ...
                if (gotocornerpostss == "1") {
                    ...
                    if (noofcornerpostval == 2) {
                        if ((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left")) {
                            glassName_d = category_name + ' ' + face_lenght_d_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");

                        } else {
                            glassName_d = category_name + ' ' + face_lenght_d_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                        }
                    } else {
            ...
            if (category_name == 'EP12' && (post_height_obj.value != 'Instock') && (post_height_obj.value != 'custom')) {
                if (height != "select") {
                    ...
                    if (gotocornerpostss == "1") {
                        ...
                        if (noofcornerpostval == 2) {
                            if (((form.posttype.value != "select") && (cornerPosition == "2nd Center Post from Left"))) {
                                glassName_d = category_name + '-' + height + ' ' + face_lenght_d_obj.value + '" Glass ' + posttypegl + ' Corner ' + postdegreegl + ' Post ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            } else {
                                glassName_d = category_name + '-' + height + ' ' + face_lenght_d_obj.value + '" Glass ' + (corner_obj.value == "yes" ? "(Radiused Corners)" : "(Squared Corners)");
                            }
                        } else {
    ...
    if ((centerPost != "") || (centerPost1 != "") || (centerPost2 != "") || (centerPost3 != "")) {
        ...
        if (gotocornerpostss == "1") {
            ...
            if (category_name == "EP22") {
                centerPost = centerPost.replace(category_name, "EP21");
    ...
    if (flangeCovers != "") {
        ...
        if (category_name == "EP12") {
            if (type_obj.value == "1BAY") {
                ...
                flangeCovers = "EP12-FLANGE COVER 1 PIECE";
    ...
    if (flangeUnderCounter != "") {
        ...
        if (category_name == "EP12") {
            ...
            if (type_obj.value == "1BAY") {
                flangeUnderCounter = "EP12-UNDER COUNTER FLANGE 1 PIECE";
    ...
    if (gotocornerpost == "1") {
        if (type_obj.value == "4BAY") {
            if (face_lenght_d_obj.value != "No Glass" || face_lenght_c_obj.value != "No Glass" || face_lenght_b_obj.value != "No Glass" || face_lenght_a_obj.value != "No Glass") {
                lightBracket = "EP12-Light Bracket";
                if (flange_covers2_obj.value == "yes") {
                    if (lightBracket != "") {
    ...
    } else if (gotocornerpost == "undefined") {
    ...
    if (type_obj.value == "2BAY" || type_obj.value == "3BAY" || type_obj.value == "4BAY") {
        ...
        if (noofcornerpostval == 2) {
            if (type_obj.value == "4BAY") {
                document.getElementById("postimg12").src = "images/EP12/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg23").src = "images/EP12/4BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg12").src = "images/EP12/3BAY/" + imgpsorname1 + "";
            }
        } else {
            ...
            if (type_obj.value == "4BAY") {
                document.getElementById("postimg1").src = "images/EP12/4BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP12/4BAY/" + imgpsorname2 + "";
                document.getElementById("postimg3").src = "images/EP12/4BAY/" + imgpsorname3 + "";
            }
            if (type_obj.value == "3BAY") {
                document.getElementById("postimg1").src = "images/EP12/3BAY/" + imgpsorname1 + "";
                document.getElementById("postimg2").src = "images/EP12/3BAY/" + imgpsorname2 + "";
            }
            if (type_obj.value == "2BAY") {
                document.getElementById("postimg1").src = "images/EP12/2BAY/" + imgpsorname1 + "";
            }
        }
    ...
    if (category_name == "EP12" && type_obj.value == "1BAY") {
    ...
    if (category_name == "EP12" && type_obj.value == "2BAY") {
        $(".msgtishu2").css("display", "none");
        //$('.post').css("top","70px");
        //$('.post').css("left","500px");
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP12" && type_obj.value == "3BAY") {
        $(".msgtishu2").css("display", "none");
        //$('.post').css("top","60px");
        // $('.post').css("left","510px");
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP12" && type_obj.value == "4BAY") {
        $(".msgtishu2").css("display", "none");
        // $('.post').css("top","50px");
        //  $('.post').css("left","530px");
        if (post_height_obj.value != "select") {
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "1BAY") {
        // $('.post').css("top","94px");
        // $('.post').css("right","120px");
        // $('.glass').css("left", "340px").css("top", "279px");
        // $('.total').css("bottom", "125px")
        if (post_height_obj.value != "select") {
            $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
            $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
        } else {
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "2BAY") {
        //$('.post').css("top","70px");
        //$('.post').css("left","504px");
        // $('.glass_a').css('bottom', '134px');
        // $('.glass_b').css('bottom', '257px');
        if (post_height_obj.value != "select") {
            $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
            $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
        } else {
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "3BAY") {
        // $('.post').css("top","63px");
        // $('.post').css("left","525px");
        // $('.glass_a').css("bottom", "120px").css("left", "196px");
        // $('.glass_b').css("bottom", "226px").css("left", "369px");
        // $('.glass_c').css("bottom", "295px").css("left", "476px");
        if (post_height_obj.value != "select") {
            $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
            $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
        } else {
    ...
    if (category_name == "EP12" && iscustomimg == 1 && type_obj.value == "4BAY") {
        // $('.post').css("top","50px");
        // $('.post').css("left","537px");
        // $('.glass_a').css("bottom", "129px").css("left", "196px");
        // $('.glass_b').css("bottom", "210px").css("left", "316px");
        // $('.glass_c').css("bottom", "271px").css("left", "416px");
        // $('.glass_d').css("bottom", "325px").css("left", "500px");
        if (post_height_obj.value != "select") {
            $('.post').text(post_height_obj.options[post_height_obj.selectedIndex].text);
            $('#c_glass_post_val').val(post_height_obj.options[post_height_obj.selectedIndex].text);
        } else {
                    ...
                    if (form.posttype.value == "inner") {
                        if (form.degree.value == "90degre") {
                            if (cornerPosition == "1st Center Post from Left") {
                                ...
                                $('.left').css("top", "40%");
                                $('.left').css("left", "9%");/*deepak 12-1-2021*/

                                $('.right').css("top", "18%");/*deepak 12-1-2021*/
                                $('.right').css("left", "90%");


                                $('.post').css("top", "68%");/*deepak 12-1-2021*/
                                $('.post').css("left", "5%");

                                $('.glass_a').css("top", "69%");/*deepak 12-1-2021*/
                                $('.glass_a').css("left", "35%");

                                $('.glass_b').css("top", "55%");/*deepak 12-1-2021*/
                                $('.glass_b').css("left", "53%");

                                $('.glass_c').css("top", "45%");
                                $('.glass_c').css("left", "69%");

                                $('.glass_d').css("top", "44%");/*deepak 12-1-2021*/
                                $('.glass_d').css("left", "75%");
    ...
    if (zero && three && four && five && six && seven && eight) {
...
function makeAdjustable(form) //third make adjustable option!!
{
    ...
    if (form.adjustable.value == "yes") {
        form.rounded_corners.value = "yes";
...
function changeGlassImage(form, image) {
    ...
    imageName = '';
    if (form.rounded_corners.value == "no") {
    ...
    //add the adjust image string here	
...
function myFunction(form) {
    ...
    if (form.type.value == "1BAY") {
        ...
        if (form.face_length_b.value == "No Glass" || form.face_length_b.value == "No Glass" || form.face_length_c.value == "No Glass") {
            ck = false;
        }
        if (form.face_length_a.value == "select") {
            x += '<li>Face Length A <span style="color:red">?</span></li>';
    ...
    $('#gotocornerpost').click(function() {
        if (screen.width >= 992 && screen.width <= 1024) {
            if ($(this).data('bay') == '2BAY') {
                $('.icons-quotes2').css('margin-top', '-7.25rem');
