...
<table id="cart-form" style="" >
    ...
    <tr>
        <td>
                ...
                <tr>
                    <td>
						<a class="thickbox" href='images/EP12/Post_height.jpg'><h1>Post Height</h1></a>
                    </td>
                    <td>
                        <span id="post_height_span">
                            <select name="post_height" id="post_height"  onchange="getPriceOfProduct(this.form)">
							   ...
							   <?php
								...
								if($post_height=='17')
								{
								echo'<option value="Instock" selected>17-1/4&quot;</option>';	
								}
								else{
								echo'<option value="Instock">17-1/4&quot;</option>';	
								}
								?>
					...
					<?php 
                        if($category_name=='EP12'){
	                       if($_REQUEST['type']=='1BAY') {
                                ?>  <tr class="test-length">
                                        <td class="test-lenght1bay"><a class="thickbox" href='images/EP12/1bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                        <td>
						...
						echo'<option value="42">42"</option>';	
                            ...
                            if($_REQUEST['type']=='2BAY'){
                                ?><tr class="test-length">
                                    <td class="test-lenght2baya"><a class="thickbox" href='images/EP12/2bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                    <td>
						...
						echo'<option value="42">42"</option>';	
                                ...
                                <tr class="test-length">
                                    <td class="test-lenght2bayb"><a class="thickbox" href='images/EP12/2bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                                    <td>
					...
					<option value="No Glass" class="customsame" style="display:none;">No Glass</option>
                            ...
                            if($_REQUEST['type']=='3BAY'){
                                ?> <tr class="test-length">
                                    <td class="test-lenght3baya"><a class="thickbox" href='images/EP12/3bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                    <td>
					                   <span id="face_length_a_span">
                                            <select name="face_length_a" id="face_length_a" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                                <option value="select">Select</option>
						...
						echo'<option value="42">42"</option>';	
                                ...
                                <tr class="test-length">
                                    <td class="test-lenght3bayb"><a class="thickbox" href='images/EP12/3bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                                    <td>
					                   <span id="face_length_b_span">
                                            <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                                 <option value="select" class="instock">Select</option>
            ...
            <tr class="test-length">
                <td class="test-lenght3bayc"><a class="thickbox" href='images/EP12/3bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                <td>
  ...
  <?  } if($_REQUEST['type']=='4BAY'){
      ?> <tr class="test-length">
                <td class="test-lenght4baya"><a class="thickbox" href='images/EP12/4bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                <td>
					<span id="face_length_a_span">
                    <select name="face_length_a" id="face_length_a" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        <option value="select">Select</option>
            ...
            <tr class="test-length">
                <td class="test-lenght4bayb"><a class="thickbox" href='images/EP12/4bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                <td>
					<span id="face_length_b_span">
                    <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                         <option value="select" class="instock">Select</option>
            ...
            <tr class="test-length">
                <td class="test-lenght4bayc"><a class="thickbox" href='images/EP12/4bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                <td>
					<span id="face_length_c_span">
                    <select name="face_length_c" id="face_length_c" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                         <option value="select" class="instock">Select</option>
			...
			<tr class="test-length">
                <td class="test-lenght4bayd"><a class="thickbox" href='images/EP12/4bay_faceD.jpg'><h1>Face Length D</h1></a></td>
                <td>
 ...
 <? }  }?>      
		  ...
		  <table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    ...
                    <tr>
                        <td>
                            <a class="thickbox" href="images/EP12/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td>
					...
					<tr id="right_lenght" style="display:none;">
                                        <td><a class="thickbox" href='images/EP12/Right_length.jpg' ><h1 style="margin-left:20px;">Right Length</h1></a></td><td>
                                    ...
                                    <tr id="left_lenght" style="display:none;">
                                        <td><center><a class="thickbox" href='images/EP12/Left_length.jpg' ><h1 style="margin-left:20px;">Left Length</h1></a></center></td><td>
					...
					<tr>
                        <td>
                            <a class="thickbox" href="images/EP12/End_panels.jpg"><h1>End Panel Type</h1></a>
                        </td>
                        <td>
                    ...
                    <tr class="test-finish" >
						...
						{
						echo'<option value="no" selected>Squared</option>';	
						}
						else{
						echo'<option value="no" >Squared</option>';	
						}
						if($glass_type=='Rounded')
						{
						echo'<option value="yes" selected>Rounded</option>';	
						}
						else{
						echo'<option value="yes" >Rounded</option>';	
						}	
		...
		<div class="tables-options" id="hidetable3">
          ...
          <table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=2><center><h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;3)</span>Extras</center></h2></td>
                    </tr>
                    <tr>
...
?>
				...
				<tr>
                        <td><a class="thickbox" href='images/EP12/post_type.jpg'><h1 style="text-decoration: none;">No of Corner Post</h1></a></td>
                        <td>
				...
				?>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP12/post_type.jpg'><h1 style="text-decoration: none;">Corner Post Type</h1></a></td>
                        <td>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP12/post_degree.jpg'><h1 style="text-decoration: none;">Corner Post Angle</h1></a></td>
                        <td>
				...
				<table id="showtable2" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
				   ...
				   <img src="images/EP12/2BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP12/3BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   ...
				   <img src="images/EP12/3BAY/INNER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
				   ...
				   <td>
				   <label>
				   <input type="radio" name="corner_post" id="1stand2ndcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP12/3BAY/INNER90D1STAND2NDPOST.jpg" style="width:90%;" id="postimg12" /></a></label></td>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP12/4BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   <td style="padding-left:5px;"><label>
				   <input type="radio" name="corner_post" id="2ndcenter" onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
				   <img src="images/EP12/4BAY/INNER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
				   ...
				   <td style="padding-left:5px;"><label>
				   <input type="radio" name="corner_post" id="2ndcenter" onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
				   <img src="images/EP12/4BAY/INNER90D2NDAND3RDPOST.jpg" id="postimg23" style="width:90%;" /></a></label></td>
				   </tr>
				   ...
				   <img src="images/EP12/4BAY/INNER90D3RDPOST.jpg" id="postimg3"  /></label></td>
			...
			<div id="cart-form"  class="tables-options forgotot11">
				...
				<table id="forgotot" cellpadding="0" align="center" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=2><center><h3 class="btspl"><a style="color:#000000;">
						...
						<label for="gotocornerpostcheck" id="gotocornerpost" data-bay="<?=$_GET['type']?>" style="float:left;"><span class="heading_all" style="float: left;"><span >&nbsp;&nbsp;4)</span></span>&nbsp;Go To Corner Post <span class="blink"><blink><b>New!</b></blink></span></center></label>						
						</a>
						</h3></td>
                    </tr>
					</table>
				...
				<table id="forstarightpost" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px; display:none;">
                    <tr>
                        <td colspan=2><center><h3 class="btspl"><a id="backtostraightpost" data-bay="<?=$_GET['type'];?>" style="color:#000000;">
						<label for="gotocornerpostcheck" style="float:left;"><span class="heading_all"><span >&nbsp;&nbsp;3)&nbsp;&nbsp;</span></span>Back To Straight Post</label></a></h3></center></td>
                    </tr>
					</table>					
				</div>					
...
<center><h2 class="heading_all" id="addcartandfavorite"><span style="float:left;">&nbsp;&nbsp;&nbsp;<?php if(($_REQUEST['type']=='1BAY')){echo "5)";}else{echo "6)";} ?></span><div class="addcartandfavdiv">Action</div></h2></center>
        ...
        <input type="hidden" id="c_glass_right_val" name="c_glass_right_val_ep12" value=""  />
        ...
        <input type="hidden" id="c_glass_left_val" name="c_glass_left_val_ep12" value=""  />
...
zero=one=two=three=four=five=six=seven=eight=nine=false;
    ...
    t3=0;
    t4=0;
    /*red line height and width variable by yogesh*/
...
<script src="includes/model_files/EP12/EP12.js"></script>