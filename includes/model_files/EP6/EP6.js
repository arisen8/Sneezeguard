                    ...
                    if (post == 'yes') {
                        ...
                        for(i=1;i<= myArray.length-lastmin;i++){
                            for(j=myArray[i];j<myArray[i+1];j++){
                                if(j>myArray[i]){
                                    if(j>42){
                                        my_facelengt_select+='<option value="'+myArray[i+1]+'" style="color:red">'+j+'"</option>';
                                    }else{
                                ...
                                {
                                    if(j>42){
                                        my_facelengt_select+='<option value="'+myArray[i]+'" style="color:red">'+j+'"</option>'; 
                                    }else{
                                ...
                                if(j!=42){
                                    if(j>=42){
                                            ...
                                            my_facelengt_select+='<option value="'+myArray[i+1]+'" style="color:red">'+j+'-1/4'+'"</option>';
                                            my_facelengt_select+='<option value="'+myArray[i+1]+'" style="color:red">'+j+'-1/2'+'"</option>';
                                            my_facelengt_select+='<option value="'+myArray[i+1]+'" style="color:red">'+j+'-3/4'+'"</option>';
...
function myFunction2(form) {
    ...
    if (myFunction(document.forms['cart_quantity'])) {
        ...
        var var1 = var2 = var3 = var4 = var5 = var6 = var7 = var8 = flange = glassheight = "";
...
function glass_height_popup(form) //first make adjustable option
{

    var glassheightss = form.glass_height_type_value.value;
    //alert(glassheightss);

    if (glassheightss == "6INCH" || glassheightss == "12INCH") {
        if (glassheightss == "6INCH") {
            var galssheightvaluee = '6"';
        } else if (glassheightss == "12INCH") {
            var galssheightvaluee = '12"';
        }
        ...
        $(document).ready(function() {
            ...
            $.confirm({
                'title': 'Confirmation',
                'message': '<div><p style="text-align:center;"><span>You have selected the following: <br /></span></p><p style="text-align:center;"><span><b>' + galssheightvaluee + ' taller glass </b>.<br /> </span></p><p style="text-align:center;"><span>Be aware this is a non stock item and requires. </span></p><p style="text-align:center;"><span><span style="color: #ff0000;">4-6 business days for production </span></span></p></div>',
                'buttons': {
                    'Proceed': {
                        'class': 'blue',
                        'action': function() {
                            getPriceOfProduct(document.forms['cart_quantity']);
                            $("#glass_height_err").attr("src", "img/iconCheckOn.gif");
                        }
                    ...
                    'Cancel': {
                        'class': 'gray',
                        'action': function() {
                                form.glass_height_type_value.value = "NO";
                                form.glass_height_type_value.selected = "Normal";
                                getPriceOfProduct(document.forms['cart_quantity']);
                            } // Nothing to do in this case. You can as well omit the action property.
...
function getProductFolderName(productname) {
    ...
    switch (productname) {
        case 'EP6':
            {
                foldername = "EP-6"; //getting the resource images from the perticular folder
                break;
            }
...
function changeGlassImage(form, image) {
    ...
    foldername = getProductFolderName("EP6") + form.type.value;
    imageName = '';
    ...
    image_string = '<img src="images/' + foldername + '/' + imageName + '" style="width:640px;height:480px">';
...
function finishImage(form, image) {
    category_name = "EP6";
    foldername = getProductFolderName("EP6");
    if (image != "") {
        imageName = image;
    }
...
function getPriceOfProduct(form) {
    ...
    if (glass_face_obj.value == 1) { //I have to change here!
        ...
        anglePost = 'EP6 90 Degree Post Brushed Stainless-Aluminum';
        ...
        if (left_lenght_obj.value != "select") {
            if (left_lenght_obj.value != "POST ONLY") {
                ...
                glassName_l = category_name + "-" + left_lenght_obj.value + "-SLGL" + glassicrese + "";
        ...
        if (right_lenght_obj.value != "select") {
            if (right_lenght_obj.value != "POST ONLY") {
                ...
                glassName_r = category_name + "-" + right_lenght_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (face_lenght_obj != null && face_lenght_obj.value != "select") {
        if (face_lenght_obj.value != "POST ONLY") {
            ...
            glassName = category_name + "-" + face_lenght_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (face_lenght_a_obj != null && face_lenght_a_obj.value != "select") {
        if (face_lenght_a_obj.value != "POST ONLY") {
            ...
            glassName_a = category_name + "-" + face_lenght_a_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (face_lenght_b_obj != null && face_lenght_b_obj.value != "select") {
        if (face_lenght_b_obj.value != "POST ONLY") {
            ...
            glassName_b = category_name + "-" + face_lenght_b_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (face_lenght_c_obj != null && face_lenght_c_obj.value != "select") {
        if (face_lenght_c_obj.value != "POST ONLY") {
            ...
            glassName_c = category_name + "-" + face_lenght_c_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (face_lenght_d_obj != null && face_lenght_d_obj.value != "select") {
        if (face_lenght_d_obj.value != "POST ONLY") {
            ...
            glassName_d = category_name + "-" + face_lenght_d_obj.value + "-SLGL" + glassicrese + "";
    ...
    if (type_obj != null) {
        if (type_obj.value == "4BAY") {
            ...
            centerPost = 'EP6 Center Post Brushed Stainless-Aluminum';
    ...
    */
    ...
    if (anglePost != "" && category_name == "EP6") {
        i = 0;
        j = 0;
    ...
    if (roastedglass != "") {
        if (category_name == "EP6") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP6-FLANGE COVER 1 PIECE";
                    ...
                    //flangeCovers="EP6-FLANGE COVER 3 PIECES";
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP6-FLANGE COVER 1 PIECE";
                        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[roastedglass][0] + '" />';
                        /* for left lenth and postb height*/
                    ...
                    //flangeCovers="EP6-FLANGE COVER 2 PIECES";
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP6-FLANGE COVER 1 PIECE";
                        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[roastedglass][0] + '" />';
                        /* for left lenth and postb height*/
    ...
    if (flangeCovers != "") {
        if (category_name == "EP6") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP6-FLANGE COVER 4 PIECES";
                    flangeCovers = "EP6-FLANGE COVER 1 PIECE";
                ...
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP6-FLANGE COVER 5 PIECES";
                    flangeCovers = "EP6-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                ...
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP6-FLANGE COVER 6 PIECES";
                    flangeCovers = "EP6-FLANGE COVER 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeCovers][0] + '" />';
    ...
    if (flangeUnderCounter != "") {
        if ("EP6" == "EP6") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    //flangeCovers="EP6-FLANGE COVER 4 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    ...
                    //flangeUnderCounter="EP6-FLANGE COVER 3 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    ...
                    //flangeUnderCounter="EP6-FLANGE COVER 2 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                ...
                if (glass_face_obj.value == 1) {
                    //flangeUnderCounter="EP6-FLANGE COVER 5 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    ...
                    //flangeUnderCounter="EP6-FLANGE COVER 4 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                ...
                if (glass_face_obj.value == 1) {
                    //flangeUnderCounter="EP6-FLANGE COVER 6 PIECES";
                    flangeUnderCounter = "EP6-UNDER COUNTER FLANGE 1 PIECE";
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
                    str += '<input type="hidden" name="products_id[]" value="' + product_name_price[flangeUnderCounter][0] + '" />';
    ...
    totalPrice1 = glassPrice + leftPostPrice + rightPostPrice + leftEndPanelPrice + rightEndPanelPrice + t_post_price + flangeCoversPrice + flangeUnderCounterPrice + flangeCoversPrice2 + parseFloat(roastedglassprice) + adjust_price + facePrice_l + facePrice_r;
    ...
    if (category_name == "EP6" || category_name == "EP15" || (category_name == "EP12") || (category_name == "EP11")) {
    ...
    if (type_obj.value == "1BAY") {
        ...
        } else if (glass_height_val == '6INCH') {
            $('.left').css("top", "1%");
            $('.left').css("left", "27%");
