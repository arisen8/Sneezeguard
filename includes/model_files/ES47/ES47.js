function getPriceOfProduct(form) {
    ...
    tube_c = "";
    tube_d = "";
    adjustable_name = "ES47 Adjustable Brackets (Pairs)";
    ...
    // 	if(face_lenght_obj!=null){
    //         face_lenght_obj.value="select";
    //         face_lenght_obj.selected="Select";
    //     }
    //     if(face_lenght_a_obj!=null){
    //         face_lenght_a_obj.value="select";
    //         face_lenght_a_obj.selected="Select";
    //     }
    //     if(face_lenght_b_obj!=null){
    //         face_lenght_b_obj.value="select";
    //         face_lenght_a_obj.selected="Select";
    //     }
    //     if(face_lenght_c_obj!=null){
    //         face_lenght_c_obj.value="select";
    //         face_lenght_c_obj.selected="Select";
    //     }
    //     if(face_lenght_d_obj!=null){
    //         face_lenght_d_obj.value="select";
    //         face_lenght_d_obj.selected="Select";
    //     }
    // }
    //Code Start Here
    //posts
    ...
    if (type_obj.value == '2BAYEXT') {
        leftEndPost = 'ES47EXTLP' + choose_finish_obj.value;
        ...
        rightEndPost = 'ES47EXTRP' + choose_finish_obj.value;
        ...
        if (type_obj.value != "1BAY") {
            //if(left_lenght_obj.value!="select"){
            centerPost = 'ES47EXTCP' + choose_finish_obj.value;
            //}
        }
    } else {
        leftEndPost = 'ES47LP' + choose_finish_obj.value;
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[leftEndPost][0] + '" />';
        leftPostPrice = parseFloat(product_name_price[leftEndPost][1]);
        rightEndPost = 'ES47RP' + choose_finish_obj.value;
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[rightEndPost][0] + '" />';
        rightPostPrice = parseFloat(product_name_price[rightEndPost][1]);
        if (type_obj.value != "1BAY") {
            //if(left_lenght_obj.value!="select"){
            centerPost = 'ES47CP' + choose_finish_obj.value;
            //}
        }
    }
    ...
    if (glass_face_obj.value == 1) {
        leftEndPanel = "ES47-g" + "LEP";
        rightEndPanel = "ES47-g" + "REP";
    ...
    if (type_obj.value == "4BAY") {
        if (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass' || face_lenght_c_obj.value == 'No Glass' || face_lenght_d_obj.value == 'No Glass') {
            ...
            if (face_lenght_a_obj.value != "select") {
                glassName_a = "ES47-" + face_lenght_a_obj.value + "GL-RND";
                ...
                //if(left_lenght_obj.value!="select"){
                topGlass_a = "ES47-" + face_lenght_a_obj.value + "TG-RND";
                if (rounded_corners_obj.value == "round") {
                    topGlass_a = "ES47-" + face_lenght_a_obj.value + "TG-RND";
                }
            ...
            if (face_lenght_b_obj.value != "select") {
                glassName_b = "ES47-" + face_lenght_b_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_b = "ES47-" + face_lenght_b_obj.value + "GL-RND";
                }
                ...
                //if(left_lenght_obj.value!="select"){
                topGlass_b = "ES47-" + face_lenght_b_obj.value + "TG-RND";
                if (rounded_corners_obj.value == "round") {
                    topGlass_b = "ES47-" + face_lenght_b_obj.value + "TG-RND";
                }
            ...
            if (face_lenght_c_obj.value != "select") {
                glassName_c = "ES47-" + face_lenght_c_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_c = "ES47-" + face_lenght_c_obj.value + "GL-RND";
                }
                ...
                //if(left_lenght_obj.value!="select"){
                topGlass_c = "ES47-" + face_lenght_c_obj.value + "TG-RND";
                if (rounded_corners_obj.value == "round") {
                    topGlass_c = "ES47-" + face_lenght_c_obj.value + "TG-RND";
                }
            ...
            if (face_lenght_d_obj.value != "select") {
                glassName_d = "ES47-" + face_lenght_d_obj.value + "GL-RND";
                form.flange_covers.disabled = false;
                if (rounded_corners_obj.value == "round") {
                    glassName_d = "ES47-" + face_lenght_d_obj.value + "GL-RND";
                }
                ...
                //if(left_lenght_obj.value!="select"){
                topGlass_d = "ES47-" + face_lenght_d_obj.value + "TG-RND";
                if (rounded_corners_obj.value == "round") {
                    topGlass_d = "ES47-" + face_lenght_d_obj.value + "TG-RND";
                }
        ...
        if (face_lenght_obj.value != "select") {
            glassName_a = "ES47-" + face_lenght_obj.value + "GL";
            //if(rounded_corners_obj.value=="round"){
            ...
            facePrice_a = parseFloat(product_name_price[glassName_a][1]);
            //if(left_lenght_obj.value!="select"){
            topGlass_a = "ES47-" + face_lenght_obj.value + "TG";
            //if(rounded_corners_obj.value=="round"){
        ...
        // 	topGlass_a=topGlass_a+"-RND";
        // }
        // if(face_lenght_obj.value == 'No Glass' && rounded_corners_obj.value==0){
        // 	// facePrice_a=0;
        // 	// topGlassPrice_a=0;
        // }else{
        // 	glassName_a=glassName_a+"-RND";
    ...
    if (flange_covers_obj.value == "yes") {
        if (type_obj.value == "4BAY") {
            if (face_lenght_a_obj.value != "select") {
                light_a = "ES47-" + face_lenght_a_obj.value + "LYT";
            ...
            if (face_lenght_b_obj.value != "select") {
                light_b = "ES47-" + face_lenght_b_obj.value + "LYT";
            ...
            if (face_lenght_c_obj.value != "select") {
                light_c = "ES47-" + face_lenght_c_obj.value + "LYT";
            ...
            if (face_lenght_d_obj.value != "select") {
                light_d = "ES47-" + face_lenght_d_obj.value + "LYT";
            ...
            if (face_lenght_a_obj.value != "select") {
                light_a = "ES47-" + face_lenght_a_obj.value + "LYTEXT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_a][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_a][1]);
            }
            if (face_lenght_b_obj.value != "select") {
                light_b = "ES47-" + face_lenght_b_obj.value + "LYTEXT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_b][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_b][1]);
            }
        } else {
            if (face_lenght_obj.value != "select") {
                light_a = "ES47-" + face_lenght_obj.value + "LYT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_a][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_a][1]);
            }
            light_b = "";
    ...
    if (type_obj.value == "4BAY") {
        if (face_lenght_a_obj.value != "select") {
            tube_a = "ES47-" + face_lenght_a_obj.value + "TUBE";
        ...
        if (face_lenght_b_obj.value != "select") {
            tube_b = "ES47-" + face_lenght_b_obj.value + "TUBE";
        ...
        if (face_lenght_c_obj.value != "select") {
            tube_c = "ES47-" + face_lenght_c_obj.value + "TUBE";
        ...
        if (face_lenght_d_obj.value != "select") {
            tube_d = "ES47-" + face_lenght_d_obj.value + "TUBE";
        ...
        if (face_lenght_obj.value != "select") {
            tube_a = "ES47-" + face_lenght_obj.value + "TUBE";
            //str+='<input type="hidden" name="products_id[]" value="'+product_name_price[tube_a][0]+'" />';
            flangeCoversPrice3 += parseFloat(product_name_price[tube_a][1]);
        }
        tube_b = "";
    ...
    if (flang_covers_obj.value == "yes") {
        flangCovers = "ES47-FLANGE COVER 1 PIECE";
        if (type_obj.value == "4BAY") {
    ...
    if (flange_under_counter_obj.value == "yes") {
        flangeUnderCounter = "ES47-UNDER COUNTER FLANGE 1 PIECE";
        if (type_obj.value == "4BAY") {
    ...
    supportPost = 'ES47SP' + choose_finish_obj.value;
    ...
    totalPrice = glassPrice + leftPostPrice + rightPostPrice + leftEndPanelPrice + rightEndPanelPrice + t_post_price + flangCoversPrice + flangeUnderCounterPrice + supportPostPrice + flangeCoversPrice + flangeCoversPrice2 + topGlassPrice + adjust_price;
...
function changeGlassImage(form, image) {
    ...
    category_name = "ES47";
    foldername = getProductFolderName("ES47") + form.type.value;
    imageName = '';
...
function finishImage(form, image) {
    ...
    category_name = "ES47";
    foldername = getProductFolderName("ES47");
    if (image != "") {
        imageName = image;
    }
