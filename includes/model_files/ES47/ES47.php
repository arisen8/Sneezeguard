...
<?php
        ...
        if(isset($HTTP_GET_VARS['id'])){
            ...
            //$product="select count(*) as total from ".TABLE_PRODUCTS." as p, ".TABLE_PRODUCTS_DESCRIPTION." as pd, ".TABLE_PRODUCTS_TO_CATEGORIES." as pc where p.products_id=pd.products_id and pd.products_id=pc.products_id and pc.categories_id='123' and pd.language_id=".(int)$languages_id;
...
var product_name_price=new Array(arr_len);
    ...
    <?php
        ...
        if(isset($HTTP_GET_VARS['id'])){
            ...
            //$product="select p.products_id as id, pd.products_name as name, p.products_price as price from ".TABLE_PRODUCTS." as p, ".TABLE_PRODUCTS_DESCRIPTION." as pd, ".TABLE_PRODUCTS_TO_CATEGORIES." as pc where p.products_id=pd.products_id and pd.products_id=pc.products_id and pc.categories_id='123' and pd.language_id=".(int)$languages_id;
...
<table id="cart-form" style="" >
    ...
    <tr>
        <td>
				...
				<?php 
    				if($category_name=='ES47'){
						if($_REQUEST['type']=='1BAY') {
      			?>  
      						<tr class="test-length">
                    			<td class="test-lenght1bay" ><a class="thickbox" href='images/ES47/1bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                    			<td>
    					...
    					if($_REQUEST['type']=='2BAY'){
        					?><tr class="test-length">
                				<td class="test-lenght2baya"><a class="thickbox" href='images/ES47/2bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                				<td>
    			        ...
    			        <tr class="test-length">
                			<td class="test-lenght2bayb"><a class="thickbox" href='images/ES47/2bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                			<td>
					...
					if($_REQUEST['type']=='2BAYEXT'){
        					?><tr class="test-length">
                				<td class="test-lenght2baya"><a class="thickbox" href='images/ES92/2bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                				<td>
									<span id="face_length_a_span">
                    					<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
    			        ...
    			        <tr class="test-length">
                			<td class="test-lenght2bayb"><a class="thickbox" href='images/ES92/2bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                			<td>
								<span id="face_length_b_span">
                	    			<select name="face_length_b" id="face_length_b" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
                    	    			<?php
    				...
    				if($_REQUEST['type']=='3BAY'){
       					?> <tr class="test-length">
                			<td class="test-lenght3baya"><a class="thickbox" href='images/ES47/3bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                			<td>
								<span id="face_length_a_span">
                    				<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
				    ...
				    <tr class="test-length">
                		<td class="test-lenght3bayb"><a class="thickbox" href='images/ES47/3bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                		<td>
							<span id="face_length_b_span">
                    			<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        			<?php
            		...
            		<tr class="test-length">
                		<td class="test-lenght3bayc"><a class="thickbox" href='images/ES47/3bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                		<td>
  					...
  					<?  } if($_REQUEST['type']=='4BAY'){
      					?> <tr class="test-length">
                				<td class="test-lenght4baya"><a class="thickbox" href='images/ES47/4bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                				<td>
									<span id="face_length_a_span">
                    					<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        					<?php
        				    ...
        				    <tr class="test-length">
                				<td class="test-lenght4bayb"><a class="thickbox" href='images/ES47/4bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                				<td>
									<span id="face_length_b_span">
                    					<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        					<?php
    			        ...
    			        <tr class="test-length">
                			<td class="test-lenght4bayc"><a class="thickbox" href='images/ES47/4bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                			<td>
								<span id="face_length_c_span">
                    				<select name="face_length_c" id="face_length_c" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >
                        				<?php
					...
					<tr class="test-length">
        		        <td class="test-lenght4bayd"><a class="thickbox" href='images/ES47/4bay_faceD.jpg'><h1>Face Length D</h1></a></td>
        		        <td>
		  ...
		  <table class="test-round" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
            	<tr>
                	...
                	<tr>
                        <td>
                            <a class="thickbox" href="images/ES47/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td>
		...
		<table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
        	...
        	<td>
        		<table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
					...
					<tr>
                        <td class="test-adjust1"><a class="thickbox" href="images/ES47/support_post.jpg"><h1>Support Post</h1></a></td>
                        <td>
					...
					<tr style="display:none;">
                        <td class="test-adjust1"><a class="thickbox" href="demo3.php?name=18&KeepThis=true&TB_iframe=true&height=480&width=640"><h1>Adjustable Brackets</h1></a></td>
                        <td>
...
<div class="info-sub-container3" valign="top" align="center">
	...
	<tr style="display:none;">
        <td style="font-size:110%;" align="left">Flange Under Counter:</td><td style="font-size:110%;" id="flange-under-counter" align="right">0.00</td>
    </tr>
		<tr>
...
zero=one=two=three=four=five=six=seven=eight=nine=ten=eleven=false;
	...
	if(isFirefox==true){
		...
		width_review=21;  
		redlinebrowser=23;
		redlinebrowser1=23;         /*red line width for price */
		redln=85;
...
<script src="includes/model_files/ES47/ES47.js"></script>