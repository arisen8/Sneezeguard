            ...
            <div class="tables-options">
                <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=3>
                            <center>
                                <h2 class="heading_all"><span style="float:left">&nbsp;&nbsp3)</span>Extras
                            </center>
                            </h2>
                        </td>
                    </tr>
...
<div class="info-sub-container3" valign="top" align="center">
    ...
    <div class="test-Price div3">
        ...
        <table id="cart-form" class="price">
            ...
            <?php
            if ($category_name == "ES67" || $category_name == "ES73") {
            ?>
            ...
            <?php if ($category_name == "ES67" || $category_name == "ES73") { ?>
                <tr>
...
<script src="includes/model_files/ES73/ES73.js"></script>