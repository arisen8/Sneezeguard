...
function getPriceOfProduct(form) {
    ...
    if (flange_covers_obj2.value != 0 && flange_covers_obj2.value != "select") {
        ...
        for (i = 1; i <= flange_covers_obj2.value; i++) {
            str +=
                '<input type="hidden" name="products_id[]" value="' +
                product_name_price[flageCovers2][0] +
                '" />';
        }
        if (flange_covers_obj2.value != "select") {
            flangeCoversPrice2 =
                parseFloat(product_name_price[flageCovers2][1]) *
                flange_covers_obj2.value;
        }
    }
    //images
            ...
            buttons: {
                Proceed: {
                    ...
                    action: function() {
                        ...
                        //	my_facelengt_simple_select+='<select name="face_length" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >';
