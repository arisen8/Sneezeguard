        ...
        <td>
    			...
    			<?php 
                    if($category_name=='EP22'){
                        if($_REQUEST['type']=='1BAY') {
                            ?>  <tr class="test-length">
                                <td class="test-lenght1bay"><a class="thickbox" href='images/EP22/1bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                <td>
                        ...
                        if($_REQUEST['type']=='2BAY'){
                            ?><tr class="test-length">
                                <td class="test-lenght2baya"><a class="thickbox" href='images/EP22/2bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                <td>
						...
						echo'<option value="42">42"</option>';	
                            ...
                            <tr class="test-length">
                                <td class="test-lenght2bayb"><a class="thickbox" href='images/EP22/2bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                                <td>
					...
					<option value="No Glass" class="customsame" style="display:none;">No Glass</option>
                        ...
                        if($_REQUEST['type']=='3BAY'){
                            ?> <tr class="test-length">
                                <td class="test-lenght3baya"><a class="thickbox" href='images/EP22/3bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                                <td>
                                    <span id="face_length_a_span">
                                        <select name="face_length_a" id="face_length_a" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                            <option value="select">Select</option>
						...
						echo'<option value="42">42"</option>';	
                            ...
                            <tr class="test-length">
                            <td class="test-lenght3bayb"><a class="thickbox" href='images/EP22/3bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                            <td>
                                <span id="face_length_b_span">
                                    <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                        <option value="select" class="instock">Select</option>
					...
					<option value="No Glass" class="customsame" style="display:none;">No Glass</option>
                        ...
                        <tr class="test-length">
                            <td class="test-lenght3bayc"><a class="thickbox" href='images/EP22/3bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                            <td>
                    ...
                    <?  } if($_REQUEST['type']=='4BAY'){
                    ?> <tr class="test-length">
                        <td class="test-lenght4baya"><a class="thickbox" href='images/EP22/4bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                        <td>
					       <span id="face_length_a_span">
                                <select name="face_length_a" id="face_length_a" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                    <option value="select">Select</option>
                    ...
                    <tr class="test-length">
                        <td class="test-lenght4bayb"><a class="thickbox" href='images/EP22/4bay_faceB.jpg'><h1>Face Length B</h1></a></td>
                        <td>
					       <span id="face_length_b_span">
                                <select name="face_length_b" id="face_length_b" class="usecustom"  onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                    <option value="select" class="instock">Select</option>
                    ...
                    <tr class="test-length">
                        <td class="test-lenght4bayc"><a class="thickbox" href='images/EP22/4bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                        <td>
                            <span id="face_length_c_span">
                                <select name="face_length_c" id="face_length_c" class="usecustom" onchange="nogl(this.form,this.name,this.value);getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                    <option value="select" class="instock">Select</option>
        			...
        			<tr class="test-length">
                        <td class="test-lenght4bayd"><a class="thickbox" href='images/EP22/4bay_faceD.jpg'><h1>Face Length D</h1></a></td>
                        <td>
		  ...
		  <table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                ...
                <tr>
                        <td>
                            <a class="thickbox" href="images/EP22/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td>
					...
					<tr id="right_lenght" style="display:none;">
                                        <td><a class="thickbox" href='images/EP22/Right_length.jpg' ><h1 style="margin-left:20px;">Right Length</h1></a></td><td>
                                    ...
                                    <tr id="left_lenght" style="display:none;">
                                        <td><center><a class="thickbox" href='images/EP22/Left_length.jpg' ><h1 style="margin-left:20px;">Left Length</h1></a></center></td><td>
					...
					<tr>
                        <td>
                            <a class="thickbox" href="images/EP22/End_panels.jpg"><h1>End Panel Type</h1></a>
                        </td>
                        <td>
                    ...
                    <tr class="test-finish" >
                        <td><div class="test-round"><a class="thickbox" style="text-color:#c7f900 !important" href=<?php echo '"images/'.$category_name.'/RADIUS.jpg"';?>><h1 >Glass Corners</h1></a></td>
                        <td>
                            <!-- <input type="checkbox" /> -->
					...
					<td class="test-light"><a class="light-bar-pricing" data-model-name="<?=$category_name;?>"><h1>Light Bar</h1></a></td>
                        <td>
                            ...
                            <select name="light_bar" id="checkbox2" style="margin:4px; float: right;" align="right" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                <option value="select">Select</option>
          ...
          <table  cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
					...
					<td><a class="adjustable-brackets-pricing" ><h1>Adjustable Brackets</h1></a></td>
                        <td>
                            ...
                            <select class="makeadjustablecheck31" name="adjustable" style="margin:4px 2px 0px 0px; float: right;width:70px;" align="right" onchange="makeAdjustable(this.form);getPriceOfProduct(this.form);">
                                <option value="no">No</option>
                                <option value="yes">Yes</option>
                            </select>
                        </td>  
...
?>
				...
				?>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP22/post_type.jpg'><h1 style="text-decoration: none;">Corner Post Type</h1></a></td>
                        <td>
				   ...
				   <tr>
                        <td><a class="thickbox" href='images/EP22/post_degree.jpg'><h1 style="text-decoration: none;">Corner Post Angle</h1></a></td>
                        <td>
				...
				<table id="showtable2" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                       <tr>
                        <td colspan=2><center><h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;2)&nbsp; </span>Choose Corner Post</h2></center></td>
                    </tr>
				   ...
				   <img src="images/EP22/2BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP22/3BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   ...
				   <img src="images/EP22/3BAY/INNER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
				   ...
				   <label>
				   <input type="radio" name="corner_post" id="1stcenter" onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
				   <img src="images/EP22/4BAY/INNER90D1STPOST.jpg"  id="postimg1" /></a></label></td>
				   <td style="padding-left:5px;"><label>
				   <input type="radio" name="corner_post" id="2ndcenter" onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
				   <img src="images/EP22/4BAY/INNER90D2NDPOST.jpg" id="postimg2"  /></a></label></td>
				   </tr>
			...
			<div id="cart-form"  class="tables-options forgotot11">
				...
				<table id="forgotot" cellpadding="0" align="center" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    <tr>
						...
						<label for="gotocornerpostcheck" id="gotocornerpost"  data-bay="<?=$_GET['type']?>" style="text-align:center !important;float:left;"><span class="heading_all"><span style="float:left;">&nbsp;&nbsp;4)</span></span>&nbsp;&nbsp;Go To Corner Post <span class="blink"><blink><b>New!</b></blink></span></label>
				...
				<table id="forstarightpost" cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px; display:none;">
                    <tr>
						...
						<label for="gotocornerpostcheck" style="text-align:center !important;float:left;"><span class="heading_all"><span style="float:left;">&nbsp;&nbsp;3)</span></span>&nbsp;&nbsp;Back To Straight Post</label></a></h3></td>
                    </tr>
					</table>
...
<!-- ani code -->
        ...
        <input type="hidden" id="c_glass_right_val" name="c_glass_right_val_ep22" value=""  />
        ...
        <input type="hidden" id="c_glass_left_val" name="c_glass_left_val_ep22" value=""  />
...
<script src="includes/model_files/EP22/EP22.js"></script>