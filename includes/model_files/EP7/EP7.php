<?php 
	  ...
	  $msg="";
		$id=$_GET['id'];
		$tp=$_GET['type'];
		$rs=tep_db_query("select * from custom_popup where id='72'and bay='1BAY'");
...
<link rel="stylesheet" href="includes/model_files/EP7/EP7.css">
<table id="cart-form"   >
    <tr>
        <td>
                ...
                <tr>
                    	...
                    	<td><a class="thickbox" href='images/EP5/1bay_faceA.jpg'><h1>Face Length</h1></a>
                    	</td>
	                ...
	                <td>
							...
							<span id="face_length_a_span">
		    	                <select name="face_length_a" onchange="getPriceOfProduct(this.form)">
									...
									if($facelengthA=='NOGL')
									{
									echo'<option value="POST ONLY" selected>POST ONLY</option>';		
									}
									
									else{
									echo'<option value="POST ONLY">POST ONLY</option>';	
									}			
									?>
		                        </select>
							</span>
			 ...
			 <div class="tables-options" style="display:none;">
		  <table class="test-round" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
	            ...
	            <tr>
                    <td><a class="thickbox" href="light.php?name=<?php echo  $category_name;?>&KeepThis=true&TB_iframe=true&height=480&width=640" ><h1>Light Bar</h1></a>
                    </td>
                    <td>
                ...
                <tr>
                	<?php if($category_name=="B950P"){?>
                    	<td><a class="thickbox" href='images/B950P/RADIUS.jpg'><h1>Battery Pack</h1></a>
                    	</td>
                    <?php }else{?>
                    	<td><a class="thickbox" href='images/EP7/RADIUS.jpg'><h1>Battery Pack</h1></a>
                    	</td>
                    <?php }?>
                    <td>
...
<div    class="info-sub-container3" valign="top" align="center" >
    ...
    <table id="cart-form" class="price" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;"> 
		<tr>
        	<td colspan=2 style=" font-size:150%;"><center><h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;2)</span>Quote</center></td>
    	</tr>
...
<center><h2 class="heading_all" id="addcartandfavorite"><span style="float:left;">&nbsp;&nbsp;&nbsp;3)</span><div class="addcartandfavdiv">Action</div></h2></center>
...
<script type="text/javascript">
	...
	$('.item .delete').click(function(){
		jsconfirm($msg,post,custom,ispost);
	});
	
});
</script>
<script src="includes/model_files/EP7/EP7.js"></script>