...
if (isFirefox == true) {
    ...
    var width_two = width_two; //width for below line!!
    width_three = 28;
...
function show_banner_options(form) //first make show_banner_options option
{
    var plexiglass_clipss = form.plexiglass_clip.value;
    if (plexiglass_clipss == 'yes') {
        $('#banner_check').css("display", "none");
        $('#banners_sidess').css("display", "none");
        form.banners.value = "no";
        form.banners.selected = "No";


    } else {
        $('#banner_check').css("display", "");
    }
...
/*make Glass Height popup */
function show_banner_popup(form) //first make adjustable option
{

    var bannersss = form.banners.value;
    //alert(glassheightss);
    ...
    if (bannersss == "yes") {
        ...
        $(document).ready(function() {
            ...
            $.confirm({
                'title': 'Confirmation',
                'message': '<div><p style="text-align: justify;color:black;"><span style="color: #ff0000;">Caution: About Glass Film </span><br><br><span>After order is placed we will contact you by email so you can provide camera ready artwork, choose background color, scale and size. Proofs will be provided for your approval. </span></p><p class="paraheight"><span id="popup-check-single"><input type="checkbox" name="banner_type" id="banner_type" class="chbddd"></span><span id="popup-name-single">Single Sided</span><span style="float:right;" id="popup-img-single"><img src="jquery.confirm/ep8-single-sided.png"  style="width:50%;"></span></p><p class="paraheight"><span id="popup-check-double"><input type="checkbox" name="banner_type2" id="banner_type2" class="chbddd"></span><span id="popup-name-double">Double Sided</span><span style="float:right;" id="popup-img-double"><img src="jquery.confirm/ep8-double-sided.png"  style="width:50%;"></span></div>',
                'buttons': {
                    'Proceed': {
                        'class': 'blue',
                        'action': function() {

                            var banner_type11 = $('#banner_type').is(':checked');
                            var banner_type21 = $('#banner_type2').is(':checked');

                            //alert(banner_type11);
                            //alert(banner_type21);
                            if (banner_type11 == true && banner_type21 == false) {
                                //alert('banner1');
                                form.banners_side.value = "single_side";
                                form.banners_side.selected = "Single Sided";


                            } else if (banner_type21 == true && banner_type11 == false) {
                                //alert('banner2');
                                form.banners_side.value = "double_side";
                                form.banners_side.selected = "Double Sided";

                            } else if (banner_type21 == true && banner_type11 == true) {
                                form.banners_side.value = "single_side";
                                form.banners_side.selected = "Single Sided";
            ...
            $('.usecustom').each(function() {
                ...
                $('[name="' + $(this).attr("name") + '"] > option').each(function() {
                    ...
                    if ($(this).val() != 'custom') {
                        ...
                        my_facelengt_select += '<option value="POST ONLY">POST ONLY</option>';
...
function getProductFolderName(productname) {
    ...
    switch (productname) {
        case 'EP8':
            {
                foldername = "EP-8"; //getting the resource images from the perticular folder
                break;
            }
...
function nogl(form, el, val) {
    ...
    if (form.type.value == "1BAY") {
        if (val == "POST ONLY" || val == 'POST ONLY"') {
            form.face_length.value = "POST ONLY";
            form.right_length.value = "POST ONLY";
            form.left_length.value = "POST ONLY";
            getPriceOfProduct(document.forms['cart_quantity']);
        } else {
    ...
    if (form.type.value == "2BAY") {
        if (val == "POST ONLY" || val == 'POST ONLY"') {
            form.face_length_a.value = "POST ONLY";
            form.face_length_b.value = "POST ONLY";
            form.right_length.value = "POST ONLY";
            form.left_length.value = "POST ONLY";
            getPriceOfProduct(document.forms['cart_quantity']);
        } else {
            if (form.face_length_a.value != "POST ONLY" && form.face_length_b.value != "POST ONLY") {
                if ($("input#glass-face").val() == 1) {
    ...
    if (form.type.value == "3BAY") {
        if (val == "POST ONLY" || val == 'POST ONLY"') {
            form.face_length_a.value = "POST ONLY";
            form.face_length_b.value = "POST ONLY";
            form.face_length_c.value = "POST ONLY";
            form.right_length.value = "POST ONLY";
            form.left_length.value = "POST ONLY";
            getPriceOfProduct(document.forms['cart_quantity']);
        } else {
            if (form.face_length_a.value != "POST ONLY" && form.face_length_b.value != "POST ONLY" && form.face_length_c.value != "POST ONLY") {
                if ($("input#glass-face").val() == 1) {
    ...
    if (form.type.value == "4BAY") {
        if (val == "POST ONLY" || val == 'POST ONLY"') {
            ...
            form.face_length_b.value = "POST ONLY";
            form.face_length_c.value = "POST ONLY";
            form.face_length_d.value = "POST ONLY";
            form.right_length.value = "POST ONLY";
            form.left_length.value = "POST ONLY";
            getPriceOfProduct(document.forms['cart_quantity']);
        } else {
            if (form.face_length_a.value != "POST ONLY" && form.face_length_b.value != "POST ONLY" && form.face_length_c.value != "POST ONLY" && form.face_length_d.value != "POST ONLY") {
                if ($("input#glass-face").val() == 1) {
...
function getPriceOfProduct(form) {
    ...
    glass_height_type_value_obj = form.glass_height_type_value;
    ...
    plexiglass_clip_obj = form.plexiglass_clip;
    banners_obj = form.banners;
    banners_side_obj = form.banners_side;
    plexiGlassClip = "";
    plexiGlassClipPrice = 0;
    ...
    if (plexiglass_clip_obj.value == "yes") { //for post height
        plexiGlassClip = "test";
    }


    $('#face_length').find('option').css("height", "40px");
    ...
    leftEndPost = category_name + " Left Post Brushed Stainless Steel";
    rightEndPost = category_name + " Right Post Brushed Stainless Steel";
    if (category_name == "EP15") {
    ...
    var glassicrese = '';
    glass_height_val = glass_height_type_value_obj.value;
    if (glass_height_val == '6INCH') {
        glassicrese = ' 6" Plus';
    } else if (glass_height_val == '12INCH') {
        glassicrese = ' 12" Plus';
    } else {
        glassicrese = '';
    }
    ...
    if (glass_face_obj.value == 1) { //I have to change here!
        ...
        anglePost = 'EP8 90 Degree Post Brushed Stainless-Aluminum';

        if (left_lenght_obj.value != "select") {
            if (left_lenght_obj.value != "POST ONLY") {


                //glassName_l=category_name+"-"+left_lenght_obj.value+"-SLGL";
                glassName_l = category_name + "-" + left_lenght_obj.value + "-Glass Film" + glassicrese + "";
        ...
        if (right_lenght_obj.value != "select") {
            if (right_lenght_obj.value != "POST ONLY") {



                glassName_r = category_name + "-" + right_lenght_obj.value + "-Glass Film" + glassicrese + "";
    ...
    if (type_obj.value == "4BAY") {
        ...
        if (glass_face_obj.value == 4) {
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || face_lenght_d_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || face_lenght_d_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || face_lenght_d_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || face_lenght_d_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
    ...
    if (type_obj.value == "3BAY") {
        ...
        var chk_gl = false;
        if (glass_face_obj.value == 4) {
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || face_lenght_c_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
    ...
    if (type_obj.value == "2BAY") {
        ...
        var chk_gl = false;
        if (glass_face_obj.value == 4) {
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_a_obj.value == 'POST ONLY' || face_lenght_b_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
    ...
    if (type_obj.value == "1BAY") {
        ...
        var chk_gl = false;
        if (glass_face_obj.value == 4) {
            if (face_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
            ...
            if (face_lenght_obj.value == 'POST ONLY' || left_lenght_obj.value == 'POST ONLY' || right_lenght_obj.value == 'POST ONLY') {
                chk_gl = true;
            } else {
                chk_gl = false;
    ...
    if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
        if (banners_side_obj.value == 'double_side') {
            var banner_sideval = 'Double Side';
        } else {
            var banner_sideval = 'Single Side';
        }
    }


    //alert(arc_glass_yn);
    //alert(plexiglass_clip_obj.value);
    ...
    if (face_lenght_obj != null && face_lenght_obj.value != "select") {
        if (face_lenght_obj.value != "POST ONLY") {
            ...
            if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
                ...
                glassName = category_name + "-" + face_lenght_obj.value + "-" + banner_sideval + " Banner";

            } else {

                glassName = category_name + "-" + face_lenght_obj.value + "-Vinyl Clear Screen";
            }
            ...
            //for seting if POST ONLY selected
            flag = 0;
        }
        // alert(glassName);
    }
    ...
    if (face_lenght_a_obj != null && face_lenght_a_obj.value != "select") {
        if (face_lenght_a_obj.value != "POST ONLY") {


            if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
                glassName_a = category_name + "-" + face_lenght_a_obj.value + "-Glass Film " + banner_sideval + " Banner";
            } else {
                glassName_a = category_name + "-" + face_lenght_a_obj.value + "-Glass Film";
            }
    ...
    if (face_lenght_b_obj != null && face_lenght_b_obj.value != "select") {
        if (face_lenght_b_obj.value != "POST ONLY") {

            if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
                glassName_b = category_name + "-" + face_lenght_b_obj.value + "-Glass Film " + banner_sideval + " Banner";
            } else {
                glassName_b = category_name + "-" + face_lenght_b_obj.value + "-Glass Film";
            }
    ...
    if (face_lenght_c_obj != null && face_lenght_c_obj.value != "select") {
        if (face_lenght_c_obj.value != "POST ONLY") {


            if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
                glassName_c = category_name + "-" + face_lenght_c_obj.value + "-Glass Film " + banner_sideval + " Banner";
            } else {
                glassName_c = category_name + "-" + face_lenght_c_obj.value + "-Glass Film";
            }
    ...
    if (face_lenght_d_obj != null && face_lenght_d_obj.value != "select") {
        if (face_lenght_d_obj.value != "POST ONLY") {


            if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
                glassName_d = category_name + "-" + face_lenght_d_obj.value + "-Glass Film " + banner_sideval + " Banner";
            } else {
                glassName_d = category_name + "-" + face_lenght_d_obj.value + "-Glass Film";
            }
    ...
    if (type_obj != null) {
        if (type_obj.value == "4BAY") {
            ...
            centerPost = 'EP8 Center Post Brushed Stainless-Aluminum';
    ...
    glass_height_val = glass_height_type_value_obj.value;
    //alert(glass_height_val);

    if (glass_height_val == '6INCH') {
        imageName = "6INCH" + imageName;
    } else if (glass_height_val == '12INCH') {
        imageName = "12INCH" + imageName;
    } else {
        //imageName=""+imageName;	
    }
    //alert(imageName)
    ...
    if (anglePost != "" && category_name == "EP8") {
        i = 0;
        j = 0;
    ...
    if (roastedglass != "") {
        if (category_name == "EP8") {
            if (type_obj.value == "1BAY") {
                if (glass_face_obj.value == 1) {
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP8-FLANGE COVER 1 PIECE";
                    ...
                    //flangeCovers="EP8-FLANGE COVER 3 PIECES";
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP8-FLANGE COVER 1 PIECE";
                        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[roastedglass][0] + '" />';
                        /* for left lenth and postb height*/
                    ...
                    //flangeCovers="EP8-FLANGE COVER 2 PIECES";
                    if (roasted_glass_obj.value == "yes") {
                        //flangeCovers="EP8-FLANGE COVER 1 PIECE";
                        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[roastedglass][0] + '" />';
                        /* for left lenth and postb height*/
    ...
    if (plexiglass_clip_obj.value == "yes") {


        plexiGlassClip = "EP8 Ring Clips";
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        str += '<input type="hidden" name="products_id[]" value="' + product_name_price[plexiGlassClip][0] + '" />';
        plexiGlassClipPrice = 6 * parseFloat(product_name_price[plexiGlassClip][1]);
        //var teeshu=getBeforeChar(left_lenght_obj.options[left_lenght_obj.selectedIndex].text);
        //alert(teeshu)
    ...
    totalPrice1 = glassPrice + leftPostPrice + rightPostPrice + leftEndPanelPrice + rightEndPanelPrice + t_post_price + flangeCoversPrice + flangeUnderCounterPrice + flangeCoversPrice2 + parseFloat(roastedglassprice) + adjust_price + facePrice_l + facePrice_r + plexiGlassClipPrice;
    ...
    if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') { //adding image of BANNER!!
        if (banners_side_obj.value == "double_side") {

            imageName = "BANNERDOUBLE" + imageName;
    ...
    if (category_name == "EP8" || category_name == "EP15" || (category_name == "EP12") || (category_name == "EP11")) {
    ...
    if (banners_obj.value == "yes") { //adding image of BANNER!!
        if (banners_side_obj.value == "double_side") {
    ...
    if (type_obj.value == "1BAY") {
        ...
        if (getAfterChar($('[name="face_length"]').find('option:selected').text()) != "") {
            n1 = (n1 + 5) + '-' + getAfterChar($('[name="face_length"]').find('option:selected').text()) + '"';
        } else { n1 = (n1 + 5) + '"'; }
        if (n1 == '5"') {
    ...
    if (banners_obj.value == 'yes' && plexiglass_clip_obj.value == 'no') {
        if (banners_side_obj.value == 'double_side') {
            var film_name_change = 'Double Sided Banner';
        } else {
            var film_name_change = 'Single Side Banner';
        }
    } else {
        var film_name_change = 'Clear Vinyl';
    }


    //film-name-change
    document.getElementById("film-name-change").innerHTML = film_name_change;
    ...
    // if(glassPrice.indexOf("."))
    // {
    // document.getElementById("face-glass").innerHTML=glassPrice+"";   
    // }
    // else{
    document.getElementById("face-glass").innerHTML = glassPrice + ".00";
    //}
    // var str=glassPrice;
    // var indexss = str.indexOf(".");    
    // if(indexss !== -1){
    ...
    document.getElementById("plexi-glass-clip").innerHTML = plexiGlassClipPrice + ".00";
    ...
    //alert(banners_obj.value);


    if (plexiglass_clip_obj.value == "select") {
        $("#plexiglass_clip_err").attr("src", "img/iconCheckOff.gif");
        five = false;
    } else {
        $("#plexiglass_clip_err").attr("src", "img/iconCheckOn.gif");
        five = true;
    }


    if (banners_obj.value == "select") {
        $("#banner_err").attr("src", "img/iconCheckOff.gif");
        five = false;
    } else {
        $("#banner_err").attr("src", "img/iconCheckOn.gif");
        five = true;
    }


    if (banners_side_obj.value == "select") {
        $("#banners_side_err").attr("src", "img/iconCheckOff.gif");
        five = false;
    } else {
        $("#banners_side_err").attr("src", "img/iconCheckOn.gif");
        five = true;
    }
...
function myFunction(form) {
    ...
    // }
    if (form.type.value == "1BAY") {
        if (form.face_length.value == "POST ONLY") {
            ck = false;
        }
...
function myFunction2(form) {
    ...
    if (myFunction(document.forms['cart_quantity'])) {
        ...
        var var1 = var2 = var3 = var4 = var5 = var6 = var7 = var8 = flange = glassheight = bannerss = bannerss_type = "";
        ...
        $.ajax({
            ...
            success: function(data, textStatus, request) {
                ...
                if (bannerss == 'yes') {
                    ...
                    //$("form[name='cart_quantity']").html($(newForm).html());
                    //alert(newForm);
                } else {
                    $("form[name='cart_quantity']").submit();
                }
        ...
        'buttons': {
            'Proceed': {
                ...
                'action': function() {
                    ...
                    if ((post == 'yes') && ('<?php echo $category_name; ?>' == 'EP8')) {
                        ...
                        if (myArray[i] == "POST ONLY") {
                            for (j = 42; j < 48; j++) {
                                if (j != 42) {
                                    my_facelengt_select += '<option value="48">' + j + '"</option>';
                                }
                                my_facelengt_select += '<option value="48">' + j + '-1/4' + '"</option>';
                                my_facelengt_select += '<option value="48">' + j + '-1/2' + '"</option>';
                                my_facelengt_select += '<option value="48">' + j + '-3/4' + '"</option>';
                            ...
                            for (j = 48; j <= 54; j++) {
                                if (j == 48) {
                                    ...
                                    my_facelengt_select += '<option value="54">' + j + '"</option>';
                                }

                                if (j != 54) {
                                    my_facelengt_select += '<option value="54">' + j + '-1/4' + '"</option>';
                                    my_facelengt_select += '<option value="54">' + j + '-1/2' + '"</option>';
                                    my_facelengt_select += '<option value="54">' + j + '-3/4' + '"</option>';
                                }
                            }
                            my_facelengt_select += '<option value="' + myArray[i] + '">' + myArray[i] + '"</option>';
                        } else {
                        ...
                        if (myArray[i] == 42) {
                            for (i = 42; i < 48; i++) {
                                if (i != 42) {
                                    my_facelengt_select += '<option value="48">' + i + '"</option>';
                                }
                                my_facelengt_select += '<option value="48">' + i + '-1/4' + '"</option>';
                                my_facelengt_select += '<option value="48">' + i + '-1/2' + '"</option>';
                                my_facelengt_select += '<option value="48">' + i + '-3/4' + '"</option>';
                            ...
                            for (i = 48; i <= 54; i++) {
                                if (i == 48) {
                                    ...
                                    my_facelengt_select += '<option value="54">' + i + '"</option>';
                                }

                                if (i != 54) {
                                    my_facelengt_select += '<option value="54">' + i + '-1/4' + '"</option>';
                                    my_facelengt_select += '<option value="54">' + i + '-1/2' + '"</option>';
                                    my_facelengt_select += '<option value="54">' + i + '-3/4' + '"</option>';
                                }
                            }
                            //my_facelengt_select+='<option value="POST ONLY">POST ONLY</option>';
                        }
