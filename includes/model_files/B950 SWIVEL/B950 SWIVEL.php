        ...
        <td>
            ...
            <div class="tables-options" id="hidetable2">
                <table cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    ...
                    <tr>
					<td class="test-light"><a class="light-bar-pricing" data-model-name="<?=$videoname;?>"><h1>Light Bar</h1></a></td>
					...
					<td class="test-light"><a class="light-bar-barcket-pricing" ><h1>Light Bracket</h1></a></td>
                        <!-- <td class="test-light"><a class="thickbox"
            ...
            <div id="cart-form" class="tables-options showtable11">
                <table id="showtable1" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100%
                    ...
                    <tr>
                        ...
                        <td><a class="thickbox" href='images/B950S/post_type.jpg'>
                    ...
                    <tr>
                        <td><a class="thickbox" href='images/B950S/post_degree.jpg'>
                ...
                <table id="showtable2" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100%
                    ...
                    <tr>
                        ...
                        <td colspan=2>
                            ...
                            <img src="images/B950S/2BAY/INNER90D1STPOST.jpg" 
                                id="postimg1" /></a></label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/B950S/3BAY/INNER90D1STPOST.jpg" 
                                    id="postimg1" /></a></label>
                        </td>
                        <td style="padding-left:5px;"><label>
                                ...
                                <img src="images/B950S/3BAY/INNER90D2NDPOST.jpg" id="postimg2"
                                   /></a></label></td>
                    </tr>
                    <?
					}
				   ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/B950S/4BAY/INNER90D1STPOST.jpg" 
                                    id="postimg1" /></a></label>
                        </td>
                        <td style="padding-left:5px;"><label>
                                <input type="radio" name="corner_post" id="2ndcenter"
                                    onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
                                <img src="images/B950S/4BAY/INNER90D2NDPOST.jpg" id="postimg2"
                                     /></a></label></td>
                    </tr>
                    ...
                    <td colspan=2 style="text-align:center;"><label>
                            ...
                            <img src="images/B950S/4BAY/INNER90D3RDPOST.jpg" id="postimg3" /></label>
                    </td>
        ...
        <tr>
            <td colspan=2 >
                <h3 class="btspl"><a style="color:#000000;">
                        <input type="checkbox" id="gotocornerpostcheck" onchange="getPriceOfProduct(this.form)"
                            name="gotocornerpostcheck" value="Go To Corner Post" style="display:none;">
                        
                        <label for="gotocornerpostcheck" id="gotocornerpost" data-bay="<?=$_GET['type'];?>" style="float:left;"><span class="heading_all"><span >&nbsp;&nbsp;3)</span></span>&nbsp;&nbsp;Go To Corner Post <span class="blink">
                                <blink><b>New!</b></blink>
                            </span></label>
        ...
        <tr>
            <td colspan=2>
                    <h3 class="btspl"><a id="backtostraightpost" data-bay="<?=$_GET['type'];?>" style="color:#000000;">
                            ...
                            <label for="gotocornerpostcheck" style="float:left;"><span class="heading_all"><span >&nbsp;&nbsp;3)</span></span>&nbsp;&nbsp;&nbsp;Back To Straight Post</label></label></a></h3>
...
<div class="info-sub-container3" valign="top" align="center">
	...
	<center><h2 class="heading_all" id="addcartandfavorite"><span style="float:left;">&nbsp;&nbsp;&nbsp;<?php if(($_REQUEST['type']=='1BAY')){echo "4)";}else{echo "5)";} ?></span><div class="addcartandfavdiv">Action</div></h2></center>
...
<script src="includes/model_files/B950 SWIVEL/B950 SWIVEL.js"></script>