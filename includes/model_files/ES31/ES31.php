        ...
        <td>
            ...
            <div class="tables-options" id="hidetable2">
                <table cellpadding="0" cellspacing="0" width=100% style="border: 1px solid white;border-radius: 5px;">
                    ...
                    <tr>
                        <td>
                            <a class="thickbox" href="images/<?php echo $category_name;?>/End_panels.jpg">
                                <h1>End Panels</h1>
                            </a>
                        </td>
                        <td>
                    ...
                    <tr id="right_lenght" style="display:none;">
                        <td><a class="thickbox" href='images/ES31/Right_length.jpg'>
                    ...
                    <tr id="left_lenght" style="display:none;">
                        <td>
                            <center><a class="thickbox" href='images/ES31/Left_length.jpg'>
                    ...
                    <tr>
                        <td>
                            <a class="thickbox" href="images/ES31/End_panels.jpg">
                                <h1>End Panel Type</h1>
                            </a>
                        </td>
                        <td>
                            <select class="option_type" id="end_options_type" name="end_options_type"
                                onchange="getPriceOfProduct(this.form);show_panel_type(this.form);">
                    ...
                    <tr class="test-finish" style="<?php echo  $display ;?>">
                        ...
                        <td>
                            <select name="rounded_corners" id="round_check" style="margin:4px;"
                                onchange="getPriceOfProduct(this.form)">
                    ...
                    <td class="test-light"><a class="light-bar-pricing" data-model-name="<?=$category_name;?>"><h1>Light Bar</h1></a></td>
                        <td>
                            <select name="light_bar" id="checkbox2" value="0" style="margin:4px; float: right;"
                                align="right" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                                <option value="select">Select</option>
...
?>
            <div id="cart-form" class="tables-options showtable11">
                <table id="showtable1" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100%
                    style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=2>
                            <center>
                                <h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;1)</span>Choose Option
                            </center>
                            </h2>
                        </td>
                    </tr>
				...
				?>
                    ...
                    <tr>
                        <td><a class="thickbox" href='images/EP22/post_type.jpg'>
                                <h1 style="text-decoration: none;">No of Corner Post</h1>
                            </a></td>
                        <td>
                            <select name="noofcornerpost" id="noofcornerpost" style="width:70px;margin:0"
                                onchange="getPriceOfProduct(this.form);change_corner_post_no();">
				...
				?>
                    ...
                    <tr>
                        <td><a class="thickbox" href='images/ES31/post_type.jpg'>
                                <h1 style="text-decoration: none;">Corner Post Type</h1>
                            </a></td>
                        <td>
                    ...
                    <tr>
                        <td><a class="thickbox" href='images/ES31/post_degree.jpg'>
                                <h1 style="text-decoration: none;">Corner Post Angle</h1>
                            </a></td>
                        <td>
            ...
            <div id="cart-form" class="tables-options showtable21">
                <table id="showtable2" align="center" style="display:none" cellpadding="0" cellspacing="0" width=100%
                    style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=2>
                            <center>
                                <h2 class="heading_all"><span style="float:left">&nbsp;&nbsp;2)</span>Choose Corner Post
                            </center>
                            </h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan=2>
                            <input type="radio" name="corner_post" id="1stcenter"
                                onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                            <img src="images/EP21/2BAY/INNER90D1STPOST.jpg" id="postimg1" /></a></label>
                        </td>
                    ...
                    <tr id="forone_corner_post">
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/EP21/3BAY/INNER90D1STPOST.jpg" id="postimg1" /></a></label>
                        </td>
                        <td style="padding-left:5px;"><label>
                                <input type="radio" name="corner_post" id="2ndcenter"
                                    onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
                    ...
                    <tr id="fortwo_corner_post" style="display:none;">
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/EP11/3BAY/INNER90D1STAND2NDPOST.jpg" style="width:90%;"
                                    id="postimg12" /></a></label>
                        </td>
				   ...
				   ?>
                    ...
                    <tr id="forone_corner_post">
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/EP21/4BAY/INNER90D1STPOST.jpg" id="postimg1" /></a></label>
                        </td>
                        <td style="padding-left:5px;"><label>
                                <input type="radio" name="corner_post" id="2ndcenter"
                                    onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
                    ...
                    <tr id="fortwo_corner_post" style="display:none;">
                        ...
                        <td>
                            <label>
                                <input type="radio" name="corner_post" id="1stcenter"
                                    onchange="getPriceOfProduct(this.form)" value="1st Center Post from Left" checked>
                                <img src="images/EP11/3BAY/INNER90D1STAND2NDPOST.jpg" style="width:100%;"
                                    id="postimg12" /></a></label>
                        </td>
                        <td style="padding-left:5px;"><label>
                                <input type="radio" name="corner_post" id="2ndcenter"
                                    onchange="getPriceOfProduct(this.form)" value="2nd Center Post from Left">
                                <img src="images/EP11/4BAY/INNER90D2NDAND3RDPOST.jpg" id="postimg23" style="width:100%;" /></a></label></td>
                    </tr>
                    ...
                    <tr id="forone_corner_post2">
                        ...
                        <td colspan=2 style="text-align: center;"><label>
                                <input type="radio" name="corner_post" id="3rdcenter"
                                    onchange="getPriceOfProduct(this.form)" value="3rd Center Post from Left">
                                <img src="images/EP21/4BAY/INNER90D3RDPOST.jpg" id="postimg3"
                                    /></label></td>
           ...
           <div id="cart-form" class="tables-options forgotot11">
                ...
                <table id="forgotot" cellpadding="0" align="center" cellspacing="0" width=100%
                    style="border: 1px solid white;border-radius: 5px;">
                    <tr>
                        <td colspan=2>
                            <h3 class="btspl"><a style="color:#000000;">
                                    <input type="checkbox" id="gotocornerpostcheck"
                                        onchange="getPriceOfProduct(this.form)" name="gotocornerpostcheck"
                                        value="Go To Corner Post" style="display:none;">
                                    <label for="gotocornerpostcheck" id="gotocornerpost" data-bay="<?=$_GET['type'];?>"
                                    style="float:left;"><span class="heading_all" style="float:left;"><span >&nbsp;&nbsp;4)</span></span>&nbsp;&nbsp;Go To Corner Post <span
                                            class="blink">
                                            <blink><b>New!</b></blink>
                                        </span></label>
                ...
                <table id="forstarightpost" cellpadding="0" cellspacing="0" width=100%
                    style="border: 1px solid white;border-radius: 5px; display:none;">
                    <tr>
                        <td colspan=2>
                                <h3 class="btspl"><a id="backtostraightpost" data-bay="<?=$_GET['type'];?>" style="color:#000000;">
                                        <label for="gotocornerpostcheck" style="float:left;"><span class="heading_all"><span >&nbsp;&nbsp;3)</span></span>&nbsp;&nbsp;&nbsp;Back To Straight Post</label></a></h3>
                        </td>
                    </tr>
                </table>
...
<div class="info-sub-container3" valign="top" align="center">
    ...
    ?>
			...
			?>
                <tr>
                    <td colspan=2>
                        <center>
                            <h2 class="heading_all" id="quotetext"><span style="float:left">&nbsp;&nbsp;5)</span>Quote
                            </h2>
                        </center>
                    </td>
                </tr>
    ...
    <center><h2 class="heading_all" id="addcartandfavorite"><span style="float:left;">&nbsp;&nbsp;&nbsp;<?php if(($_REQUEST['type']=='1BAY')){echo "5)";}else{echo "6)";} ?></span><div class="addcartandfavdiv">Action</div></h2></center>
        ...
        <input type="hidden" id="c_glass_right_val" name="c_glass_right_val_es31" value=""  />
        ...
        <input type="hidden" id="c_glass_left_val" name="c_glass_left_val_es31" value=""  />
...
<script src="includes/model_files/ES31/ES31.js"></script>