...
function getPriceOfProduct(f) {
    ...
    if ($('#is_custom').val() == 'Yes') {
        ...
        if (h.length == 2) {
            ...
            totall=parseInt(h1) + parseInt(6);
            $("div.glass_a").html(h1 - 2 + '-' + h2 + '');//deepak 1-2-2021
            $("div.glass_b").html(totall + '-' + h2 + '');
        } else {
            h = String(h);
            h = h.split('"');
            h = parseInt(h);
            ...
            if (isNaN(h)) {
                $(".glass_a").html("Length");
                $("div.glass_b").html("Total");
            } else {
                totall=parseInt(h) + parseInt(6);
                $(".glass_a").html(h - 2 + '"');//deepak 1-2-2021
                $("div.glass_b").html(totall + '"');
            }
        }
    } else {
        totall=parseInt(a) + parseInt(6);
        if (f.face_length_a.value != "select") {
            $(".glass_a").html(a - 2 + '"');//deepak 1-2-2021
            $(".glass_b").html(totall + '"');
        } else {
            $(".glass_a").html("LENGTH");
            $(".glass_b").html("Total");
