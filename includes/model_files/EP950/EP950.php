...
<link rel="stylesheet" href="includes/model_files/EP950/EP950.css">
<table id="cart-form">
    <tr>
        <td>
		  ...
		  <table class="test-round" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid white;border-radius: 5px;">
				...
				<tr>
                	<?php if($category_name=="EP950"){?>
                    	<td><a class="thickbox" href='images/EP950/RADIUS.jpg'><h1>Battery Pack</h1></a>
                    	</td>
                    <?php }else{?>
                    	<td><a class="thickbox" href='images/EP950/RADIUS.jpg'><h1>Battery Pack</h1></a>
                    	</td>
                    ...
                    <td>
                        ...
                        <select id="checkbox3" name="rounded_corners2"  onchange="getPriceOfProduct(this.form);" disabled="disabled">
                        	<option value="select">Select</option>
                        	<option value="yes">Yes</option>
				...
				<tr>
                    ...
                    <td>
                        <select name="choose_finish" id="choose_finish2"  onchange="getPriceOfProduct(this.form)">
...
<script src="includes/model_files/EP950/EP950.js"></script>
