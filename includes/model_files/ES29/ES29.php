...
<link rel="stylesheet" href="includes/model_files/ES29/ES29.css" >
...
<table id="cart-form" style="" >
    ...
    <tr>
        <td>
                ...
                <tr id="right_lenght">
                    <td><a class="thickbox" href='images/ES29/Depth.jpg'><h1>Countertop Width</h1></a></td>
                    <td>
		       ...
		       <?php 
					if($_REQUEST['type']=='1BAY') {
      					?>  <tr class="test-length">
                    		<td class="test-lenght1bay"><a class="thickbox" href='images/ES29/1bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                    		<td>
						...
						echo '<option value="No Glass">No Glass</option>
										';
    				...
    				if($_REQUEST['type']=='2BAY'){
        				?><tr class="test-length">
                			<td class="test-lenght2baya"><a class="thickbox" href='images/ES29/2bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                			<td>
			            ...
			            <tr class="test-length">
            			    <td class="test-lenght2bayb"><a class="thickbox" href='images/ES29/2bay_faceB.jpg'><h1>Face Length B</h1></a></td>
            			    <td>
    				...
    				if($_REQUEST['type']=='3BAY'){
       					?> <tr class="test-length">
                			<td class="test-lenght3baya"><a class="thickbox" href='images/ES29/3bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                			<td>
								<span id="face_length_a_span">
                    				<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
			            ...
			            <tr class="test-length">
            			    <td class="test-lenght3bayb"><a class="thickbox" href='images/ES29/3bay_faceB.jpg'><h1>Face Length B</h1></a></td>
            			    <td>
								<span id="face_length_b_span">
                    				<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
            			...
            			<tr class="test-length">
                			<td class="test-lenght3bayc"><a class="thickbox" href='images/ES29/3bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                			<td>
  					...
  					<?php  } if($_REQUEST['type']=='4BAY'){
      					?> <tr class="test-length">
                			<td class="test-lenght4baya"><a class="thickbox" href='images/ES29/4bay_faceA.jpg'><h1>Face Length A</h1></a></td>
                			<td>
								<span id="face_length_a_span">
                    				<select name="face_length_a" id="face_length_a" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
			            ...
			            <tr class="test-length">
            			    <td class="test-lenght4bayb"><a class="thickbox" href='images/ES29/4bay_faceB.jpg'><h1>Face Length B</h1></a></td>
            			    <td>
								<span id="face_length_b_span">
                    				<select name="face_length_b" id="face_length_b" class="usecustom"  onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
			            ...
			            <tr class="test-length">
                			<td class="test-lenght4bayc"><a class="thickbox" href='images/ES29/4bay_faceC.jpg'><h1>Face Length C</h1></a></td>
                			<td>
								<span id="face_length_c_span">
                    				<select name="face_length_c" id="face_length_c" class="usecustom" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);">
                        				<?php
						...
						<tr class="test-length">
                			<td class="test-lenght4bayd"><a class="thickbox" href='images/ES29/4bay_faceD.jpg'><h1>Face Length D</h1></a></td>
                			<td>
		  ...
		  <tr>
            		...
            		<tr>
                        <td>
                            <a class="thickbox" href="images/ES29/End_panels.jpg"><h1>End Panels</h1></a>
                        </td>
                        <td>
			     ...
			     <tr style="display:none;">
					...
					<td class="test-light"><a class="light-bar-pricing" data-model-name="<?=$category_name;?>"><h1>Light Bar</h1></a></td>
						<td>  
						  	<select name="flange_covers" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" style="width: 96px;">
                                <option value="select">Select</option>
								
								
                                <option value="TL">Top Light</option>
                                <option value="BL">Back Light</option>
                    ...
                    <tr>
                		<td ><a class="thickbox" href='images/Finishes.jpg'><h1>Post Finish</h1></a></td><td>
...
redln=85;
	...
	zero=one=two=three=four=five=six=seven=eight=nine=ten=false;
    choseOption=0;
	...
	choseTishu=0; //use for flange cover
...
<script src="includes/model_files/ES29/ES29.js"></script>