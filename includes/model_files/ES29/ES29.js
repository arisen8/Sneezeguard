function getPriceOfProduct(form) {
    ...
    light_c = "";
    light_d = "";
    adjustable_name = "ES29 Adjustable Brackets (Pairs)";
    ...
    flange_covers_obj2 = ""; //use Form Light Bracket
    ...
    if (type_obj.value == "4BAY") {
        ...
        if (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass' || face_lenght_c_obj.value == 'No Glass' || face_lenght_d_obj.value == 'No Glass') {
            flange_covers_obj.value = "0";
            flange_covers_obj.selected = "No Light";
            flange_covers_obj.disabled = true;
            if (centerPost != "") {
            ...
            flange_covers_obj.disabled = false;
        }
    }
    ...
    } else if (type_obj.value == "3BAY" && flag) {
        if (face_lenght_a_obj.value != "select") {
            glassName_a = c_name + "-" + face_lenght_a_obj.value + "GL";
            if (rounded_corners_obj.value == "round") {
                glassName_a = glassName_a + "-RND";
    ...
    } else if (type_obj.value == "2BAY" && flag) {
        //alert("going inside tha condition");
        if (face_lenght_a_obj.value != "select") {
            glassName_a = c_name + "-" + face_lenght_a_obj.value + "GL";
    ...
    } else if (type_obj.value == "1BAY" && flag) {
    ...
    if (flange_covers_obj.value == 'TL') {
        if (type_obj.value == "4BAY") {
            if (face_lenght_a_obj.value != "select") {
                light_a = c_name + "-" + face_lenght_a_obj.value + "TOPLYT";
            ...
            if (face_lenght_b_obj.value != "select") {
                light_b = c_name + "-" + face_lenght_b_obj.value + "TOPLYT";
            ...
            if (face_lenght_c_obj.value != "select") {
                light_c = c_name + "-" + face_lenght_c_obj.value + "TOPLYT";
            ...
            if (face_lenght_d_obj.value != "select") {
                light_d = c_name + "-" + face_lenght_d_obj.value + "TOPLYT";
            ...
            if (face_lenght_obj.value != "select") {
                light_a = c_name + "-" + face_lenght_obj.value + "TOPLYT";
    ...
    //LIGHTBAR FOR BACKLIGHT

    if (flange_covers_obj.value == 'BL') {
        if (type_obj.value == "4BAY") {
            if (face_lenght_a_obj.value != "select") {
                light_a = c_name + "-" + face_lenght_a_obj.value + "BKLYT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_a][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_a][1]);
            }
            if (face_lenght_b_obj.value != "select") {
                light_b = c_name + "-" + face_lenght_b_obj.value + "BKLYT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_b][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_b][1]);
            }
            if (face_lenght_c_obj.value != "select") {
                light_c = c_name + "-" + face_lenght_c_obj.value + "BKLYT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_c][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_c][1]);
            }
            if (face_lenght_d_obj.value != "select") {
                light_d = c_name + "-" + face_lenght_d_obj.value + "BKLYT";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_d][0] + '" />';
                flangeCoversPrice += parseFloat(product_name_price[light_d][1]);
            }
        } else if (type_obj.value == "3BAY") {
            ...
            if (face_lenght_obj.value != "select") {
                light_a = c_name + "-" + face_lenght_obj.value + "BKLYT";
                light_b = "";
                light_c = "";
                str += '<input type="hidden" name="products_id[]" value="' + product_name_price[light_a][0] + '" />';
                flangeCoversPrice = parseFloat(product_name_price[light_a][1]);
    ...
    if (flang_covers_obj.value == "yes") {
        ...
        flangCovers = "ES29-FLANGE COVER 1 PIECE";
    ...
    if (flange_under_counter_obj.value == "yes") {
        ...
        flangeUnderCounter = "ES29-UNDER COUNTER FLANGE 1 PIECE";
    ...
    if (choose_finish_obj.value == "SS") {
        if (rounded_corners_obj.value == "squared" || rounded_corners_obj.value == "select") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                imageName = imageName;
            } else if (flange_covers_obj.value == 'BL') {
                imageName = "BACK" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "TOP" + imageName;
            }
        } else if (rounded_corners_obj.value == "round") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                if (flag == 1) {
                ...
                imageName = "BACKRUND" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "TOPRUND" + imageName;
            }
        }

        //          if(flange_covers_obj.value !='TL' && (rounded_corners_obj.value=="squared" || rounded_corners_obj.value=="select") && flange_covers_obj.value !='BL'){

        //              imageName=imageName;

        //          } else if(flange_covers_obj.value !='TL' && (rounded_corners_obj.value=="squared" || rounded_corners_obj.value=="select") && flange_covers_obj.value =='BL'){
        ...
        // else if(flange_covers_obj.value =='TL' && rounded_corners_obj.value=="round" && flange_covers_obj.value !='BL'){
        ...
        if (rounded_corners_obj.value == "squared" || rounded_corners_obj.value == "select") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                ...
                imageName = "BLACKBACK" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "BLACKTOP" + imageName;
            }
        } else if (rounded_corners_obj.value == "round") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                if (flag == 1) {
                ...
                imageName = "BLACKBACKRUND" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "BLACKTOPRUND" + imageName;
            }
        }
        ...
        if (rounded_corners_obj.value == "squared" || rounded_corners_obj.value == "select") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                ...
                imageName = "ALMNBACK" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "ALMNTOP" + imageName;
            }
        } else if (rounded_corners_obj.value == "round") {
            if (flange_covers_obj.value == '0' || flange_covers_obj.value == "select") {
                if (flag == 1) {
                ...
                imageName = "ALMNBACKRUND" + imageName;
            } else if (flange_covers_obj.value == 'TL') {
                imageName = "ALMNTOPRUND" + imageName;
            }
        }
        //  if(flange_covers_obj.value !='TL' && (rounded_corners_obj.value=="squared" || rounded_corners_obj.value=="select") && flange_covers_obj.value !='BL'){
    ...
    if (type_obj.value == "2BAY") {
        ...
        if (flange_covers_obj.value != 'TL' && (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass')) {
    ...
    if (type_obj.value == "3BAY") {
        ...
        if (flange_covers_obj.value != 'TL' && (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass' || face_lenght_c_obj.value == 'No Glass')) {
    ...
    if (type_obj.value == "4BAY") {
        ...
        if (flange_covers_obj.value != 'TL' && (face_lenght_a_obj.value == 'No Glass' || face_lenght_b_obj.value == 'No Glass' || face_lenght_c_obj.value == 'No Glass' || face_lenght_d_obj.value == 'No Glass')) {
    ...
    totalPrice = glassPrice + leftPostPrice + rightPostPrice + leftEndPanelPrice + rightEndPanelPrice + t_post_price + flangCoversPrice + flangeCoversPrice + flangeUnderCounterPrice + flangeCoversPrice2 + topGlassPrice + adjust_price;
    ...
    if (glass_face_obj.value == 1) {
        ...
        if (right_lenght_obj.value != "select") {
            $("div.right").text((right_lenght_obj.value) - 4 + '"');
            $("div.left").text(right_lenght_obj.value + '"');
        } else {
            $("div.right").text("Inner Width");
            $("div.left").text("Countertop width");
            ...
            'buttons': {
                ...
                'Proceed': {
                    ...
                    'action': function() {
                        ...
                        my_facelengt_select += '<select name="' + custom.attr("name") + '" onchange="getPriceOfProduct(this.form);show_lightbar_pupup(this.form);" >';
...
function getTotal3(n1, n2, n3, n4, f_n1, f_n2) {
    ...
    if (f_n1 == '1/4' && f_n2 == '3/4') { t += 1;
        t += '"'; }
    if (f_n1 == '1/2' && f_n2 == '1/4') { t += '-3/4"'; }
    if (f_n1 == '1/2' && f_n2 == '1/2') { t += 1;
        t += '"'; }
    if (f_n1 == '1/2' && f_n2 == '3/4') { t += '-5/4"'; }
    if (f_n1 == '3/4' && f_n2 == '1/4') { t += 1;
        t += '"'; }
    if (f_n1 == '3/4' && f_n2 == '1/2') { t += 1;
        t += '-1/4"'; }
    if (f_n1 == '3/4' && f_n2 == '3/4') { t += 1;
        t += '-1/2"'; }
    if (f_n1 == "" && f_n2 != "") { t += "-" + f_n2 + '"'; }
    if (f_n2 == "" && f_n1 != "") { t += "-" + f_n1 + '"'; }
...
function getTotal63(n1, n2, f_n1, f_n2) {
    ...
    if (f_n1 == '1/2' && f_n2 == '3/4') { t += 1;
        t += '-1/4"'; }
    if (f_n1 == '3/2' && f_n2 == '1/4') { t += 1;
        t += '-3/4"'; }
    if (f_n1 == '3/2' && f_n2 == '3/4') { t += 2;
        t += '-1/4"'; }
...
function changeGlassImage(form, image) {
    ...
    if (form.adjustable.value == "1") { //adding image of adjustable breckets!!
        //              alert(imageName);
        imageName = "ADJUST" + imageName;
...
function show_lightbar_pupup(form) {
    ...
    if (lightbarss == 'TL' || lightbarss == 'BL') {
        // var val_a='8-1/4"';
                    ...
                    'buttons': {
                        'Proceed': {
                            ...
                            'action': function() {
                                ...
                                form.flange_covers.value = "0";
                                form.flange_covers.selected = "No Light";
...
// leftstr='<td><h1></h1><select name="left_length" onchange="getPriceOfProduct(this.form)" disabled="disabled"> <option value="12">12&quot;</option><option value="18">18&quot;</option><option value="24">24&quot;</option></select></td>';

// rightstr='<td><h1 style="width:60px">Countertop Width</h1><select name="right_length" onchange="getPriceOfProduct(this.form)" disabled="disabled"> <?php for($i=24; $i<=54; $i++){?><option value="<?php echo $i;?>"><?php echo $i.'"';?></option><?php }?></select></td>';
