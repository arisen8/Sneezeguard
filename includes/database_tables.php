...
// define the database table names used in the project
  ...
  define('TABLE_DISCOUNT_CODES', 'discount_codes');
   //BOF - Zappo - Option Types v2 - ONE LINE - File Uploading
  define('TABLE_PRODUCTS_OPTIONS_TYPES', 'products_options_types');  //BOF - Zappo - Option Types v2 - ONE LINE - Option Types
  define('TABLE_CART_MESSAGE','cart_message');
  define('TABLE_CONDITION_AND_TERM', 'condition_and_term');

  
  
    // Discount Code 3.1.1 - start
  define('TABLE_CUSTOMERS_TO_DISCOUNT_CODES_CUSTOMER', 'customers_to_discount_codes_customer');
  define('TABLE_DISCOUNT_CODES_CUSTOMER', 'discount_codes_customer');
