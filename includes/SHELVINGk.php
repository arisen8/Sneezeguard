    ...
    <?php
        if(isset($HTTP_GET_VARS['id'])){
           ...
           <? } if($category_name=='EP12'||$category_name=='EP22'){ ?>
            ...
            <? } if($category_name=='Adjustable-Shelving'){ ?>
                product_name_price['Brackets']=new Array("1380", "35.0000");
...
<script type="text/javascript">
    function getPriceOfProduct(f){
        ...
        if(f.post_height.value!=0){
            ...
            if(type.value=="1BAY"){
               ...
               // $(".total").html(parseInt(f.face_length_a.value)+2);
                ...
                var no_of_selvs_a=f.bracket_a.value;
                
                for(i=1;i<=no_of_selvs_a;i++){
                      str+='<input type="hidden" name="products_id[]" value="'+product_name_price[face_glass_a][0]+'" />';
                      str+='<input type="hidden" name="products_id[]" value="'+product_name_price[bracket][0]+'" />';  
                    } 
                
                total=(no_of_selvs_a*parseFloat(brackets_price))+(no_of_selvs_b*parseFloat(brackets_price))+(no_of_selvs_c*parseFloat(brackets_price))+(no_of_selvs_a*parseFloat(face_glass_a_price))+(no_of_selvs_b*parseFloat(face_glass_b_price))+(no_of_selvs_c*parseFloat(face_glass_c_price))+parseFloat(left_price)+parseFloat(right_price)+parseFloat(center_price)+parseFloat(center_price)+4*parseFloat(flange_price);
               ...
               // $(".total").html(parseInt(f.face_length_a.value)+parseInt(f.face_length_b.value)+2);
                ...
                var no_of_selvs_a=f.bracket_a.value;
                var no_of_selvs_b=f.bracket_b.value;
                for(i=1;i<=no_of_selvs_a;i++){
                      str+='<input type="hidden" name="products_id[]" value="'+product_name_price[face_glass_a][0]+'" />';
                      str+='<input type="hidden" name="products_id[]" value="'+product_name_price[bracket][0]+'" />';  
                    }
                ...
                total=(no_of_selvs_a*parseFloat(brackets_price))+(no_of_selvs_b*parseFloat(brackets_price))+(no_of_selvs_c*parseFloat(brackets_price))+(no_of_selvs_a*parseFloat(face_glass_a_price))+(no_of_selvs_b*parseFloat(face_glass_b_price))+(no_of_selvs_c*parseFloat(face_glass_c_price))+parseFloat(left_price)+parseFloat(right_price)+parseFloat(center_price)+6*parseFloat(flange_price);
              ...
              img+='<div class="glass">12"</div><div class="glass_a">12"</div><div class="glass_b">12"</div><div class="glass_c">12"</div><div class="total">38"</div>';
               ...
               c=f.face_length_c.value;
                ...
                var no_of_selvs_a=f.bracket_a.value;
                var no_of_selvs_b=f.bracket_b.value;
                var no_of_selvs_c=f.bracket_c.value;
                 for(i=1;i<=no_of_selvs_a;i++){
                      str+='<input type="hidden" name="products_id[]" value="'+product_name_price[face_glass_a][0]+'" />';
                       str+='<input type="hidden" name="products_id[]" value="'+product_name_price[bracket][0]+'" />';  
                    }
                ...
                total=(no_of_selvs_a*parseFloat(brackets_price))+(no_of_selvs_b*parseFloat(brackets_price))+(no_of_selvs_c*parseFloat(brackets_price))+(no_of_selvs_a*parseFloat(face_glass_a_price))+(no_of_selvs_b*parseFloat(face_glass_b_price))+(no_of_selvs_c*parseFloat(face_glass_c_price))+parseFloat(left_price)+parseFloat(right_price)+parseFloat(center_price)+8*parseFloat(flange_price);
        ...
        brackets_price=(no_of_selvs_a*parseFloat(bracket_price))+(no_of_selvs_b*parseFloat(bracket_price))+(no_of_selvs_c*parseFloat(bracket_price))
        ...
        $("#bracket").html(brackets_price+".00");
...
<div class="test-Price">
    <table id="cart-form" class="price"> 
        ...
        <tr>
            <td align="left">Brackets:</td><td id="bracket" align="right">0.00</td>
        </tr>
        <tr>
