...
$query_checkss=mysql_query($con,"SELECT * customers_basket WHERE customers_id='$customers_id' AND products_id='$productid' AND product_val='$product_val'");
 if (mysql_num_rows($query_checkss)) {
