...
?>
  ...
  <div class="contentText">
    <div  style="float: Left; padding:5px;">
      <div ><?php //echo TITLE_SHIPPING_ADDRESS; ?></div>
<b>
      <div >
...
?>
      ...
      <tr>
        <td colspan="2" style="padding-left: 15px; padding-right:170px"><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?></td>
      </tr>
...
<div class="contentText" style="text-align:right;">
 <br />
<!--
...
<!-- <input type="image" src="img/new_icons/continue.png" alt="Submit" style="width:45%"> -->
</div>
</div>
</div>
