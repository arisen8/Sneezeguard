...
/*
  ...
  2010 Nov 17 v.3.7 Angel Delgado			Fixed updateIps() function. The IP address geolocation (country,region,city) with IPInfoDB 	
  											XML API changed on 15-November-2010. Now it works again with this fixed.

  2010 Apr 12 v.3.6.6.2 www.Xunlock.no			Fixed deprecated functions eregi() and split() by replacing them with preg_match() and explode() and doing minor code changes so it works for PHP 5.3 and newer PHP version.
...
function updateIps($ips){
	...
	$ipinfodb->setKey('<ENTER API KEY WITH IPINFODB.COM >');
            ...
            <tr>
              <td>
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
				  	<!-- Angel - Quitamos el número de la versión del Whois Online -->
